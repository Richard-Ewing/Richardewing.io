...
export const metadata: Metadata = {
  ...
  description: 'Index of original frameworks and industry concepts in AI economics, governance, and software capital. Links field research to decision models.',
  alternates: {
