...
export const metadata: Metadata = {
    title: 'Data Infrastructure Cost Optimization \u2014 Cut Data Stack Costs 40% | Richard Ewing',
    description: 'Data Infrastructure Cost Optimization: Cut Data Stack Costs 40%. A comprehensive engineering economics guide by Richard Ewing.',
    keywords: ['data infrastructure optimization', 'engineering economics', 'richard ewing', 'free guide'],
    alternates: { canonical: 'https://www.richardewing.io/guides/data-infrastructure-optimization' },
    openGraph: { title: 'Data Infrastructure Cost Optimization', description: 'Cut Data Stack Costs 40%. Engineering economics guide.', url: 'https://www.richardewing.io/guides/data-infrastructure-optimization', type: 'article' },
};
...
export default function DataInfrastructureOptimizationPage() {
    const articleSchema = {
        ...
        headline: 'Data Infrastructure Cost Optimization \u2014 Cut Data Stack Costs 40%',
        description: 'Data Infrastructure Cost Optimization: comprehensive engineering economics guide.',
        author: { '@type': 'Person', name: 'Richard Ewing', url: 'https://www.richardewing.io/principal' },
        publisher: { '@type': 'Person', name: 'Richard Ewing' },
        url: 'https://www.richardewing.io/guides/data-infrastructure-optimization',
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://www.richardewing.io/guides/data-infrastructure-optimization' },
    };
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'Data Infrastructure Cost Optimization', item: 'https://www.richardewing.io/guides/data-infrastructure-optimization' },
        ],
    };
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-[10px] font-mono text-zinc-600 uppercase tracking-widest">
                        <Link href="/guides" className="hover:text-cyan-400">Guides</Link><span>/</span><span className="text-cyan-400 font-bold">Data Infrastructure Cost Optimization</span>
                    </div>
                    <h1 className="text-4xl sm:text-5xl font-grotesk font-bold text-white mb-6">
                        Data Infrastructure Cost{' '}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-violet-400">Optimization</span>
                    </h1>
                    <p className="text-lg text-zinc-400 mb-4 max-w-2xl">Cut Data Stack Costs 40%. A comprehensive engineering economics guide.</p>
                    ...
                    <div className="rounded-2xl border border-cyan-500/30 bg-cyan-500/5 p-8 mb-16">
                        ...
                        <Link href="/advisory" className="inline-block px-8 py-4 rounded-lg bg-gradient-to-r from-cyan-500 to-violet-500 text-white font-bold hover:opacity-90 transition-opacity">Book an R&D Capital Audit \u2192</Link>
                    </div>
                <RelatedContent currentSlug="data-infrastructure-optimization" type="guide" count={3} />
                    </div>
                </div>
            </main>
    );
