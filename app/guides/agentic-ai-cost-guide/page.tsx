...
export const metadata: Metadata = {
    title: 'Agentic AI Cost Guide \u2014 What AI Agents Actually Cost to Build, Deploy, and Operate | Richard Ewing',
    description: 'Agentic AI Cost Guide: What AI Agents Actually Cost to Build, Deploy, and Operate. A comprehensive engineering economics guide by Richard Ewing.',
    keywords: ['agentic', 'ai', 'cost', 'guide', 'engineering economics', 'richard ewing'],
    alternates: { canonical: 'https://www.richardewing.io/guides/agentic-ai-cost-guide' },
    openGraph: { title: 'Agentic AI Cost Guide', description: 'What AI Agents Actually Cost to Build, Deploy, and Operate. Engineering economics guide.', url: 'https://www.richardewing.io/guides/agentic-ai-cost-guide', type: 'article' },
};

const sections = [
    {
        title: 'Agent Architecture & Cost Models',
        description: 'Understanding the cost structure of agentic AI systems',
        slugs: ["technical-debt", "architecture-debt", "infrastructure-debt", "legacy-modernization", "total-cost-of-ownership"],
        color: 'cyan',
    },
    {
        title: 'LLM Inference Economics',
        description: 'Token pricing, batching strategies, and model selection',
        slugs: ["capex-vs-opex", "cost-of-delay", "innovation-tax", "maintenance-load", "engineering-economics"],
        color: 'violet',
    },
    {
        title: 'Multi-Agent System Pricing',
        description: 'Orchestration overhead and scaling costs',
        slugs: ["build-vs-buy", "vendor-lock-in", "platform-engineering", "feature-velocity", "deployment-frequency"],
        color: 'amber',
    },
    {
        title: 'ROI Framework for AI Agents',
        description: 'Measuring and justifying autonomous AI investments',
        slugs: ["revenue-per-engineer", "engineering-roi", "product-market-fit", "unit-economics", "r-and-d-capitalization"],
        color: 'emerald',
    },
];
...
export default function AgenticAiCostGuidePage() {
    const articleSchema = {
        '@context': 'https://schema.org', '@type': 'Article',
        headline: 'Agentic AI Cost Guide \u2014 What AI Agents Actually Cost to Build, Deploy, and Operate',
        description: 'Agentic AI Cost Guide: comprehensive engineering economics guide.',
        author: { '@type': 'Person', name: 'Richard Ewing', url: 'https://www.richardewing.io/principal' },
        publisher: { '@type': 'Person', name: 'Richard Ewing' },
        url: 'https://www.richardewing.io/guides/agentic-ai-cost-guide',
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://www.richardewing.io/guides/agentic-ai-cost-guide' },
    };
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'Agentic AI Cost Guide', item: 'https://www.richardewing.io/guides/agentic-ai-cost-guide' },
        ],
    };
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-[10px] font-mono text-zinc-600 uppercase tracking-widest">
                        <Link href="/guides" className="hover:text-cyan-400">Guides</Link><span>/</span><span className="text-cyan-400 font-bold">Agentic AI Cost Guide</span>
                    </div>
                    <h1 className="text-4xl sm:text-5xl font-grotesk font-bold text-white mb-6">
                        Agentic AI Cost{' '}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-400">Guide</span>
                    </h1>
                    <p className="text-lg text-zinc-400 mb-4 max-w-2xl">What AI Agents Actually Cost to Build, Deploy, and Operate. A comprehensive engineering economics guide.</p>
                ...
                <RelatedContent currentSlug="agentic-ai-cost-guide" type="guide" count={3} />
                    </div>
                </div>
            </main>
    );
