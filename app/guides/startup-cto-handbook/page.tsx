...
export const metadata: Metadata = {
    title: 'The Startup CTO Handbook \u2014 First Commit to Series B | Richard Ewing',
    description: 'The Startup CTO Handbook: First Commit to Series B. A comprehensive engineering economics guide by Richard Ewing.',
    keywords: ['startup cto handbook', 'engineering economics', 'richard ewing', 'free guide'],
    alternates: { canonical: 'https://www.richardewing.io/guides/startup-cto-handbook' },
    openGraph: { title: 'The Startup CTO Handbook', description: 'First Commit to Series B. Engineering economics guide.', url: 'https://www.richardewing.io/guides/startup-cto-handbook', type: 'article' },
};
...
export default function StartupCtoHandbookPage() {
    const articleSchema = {
        '@context': 'https://schema.org', '@type': 'Article',
        headline: 'The Startup CTO Handbook \u2014 First Commit to Series B',
        description: 'The Startup CTO Handbook: comprehensive engineering economics guide.',
        author: { '@type': 'Person', name: 'Richard Ewing', url: 'https://www.richardewing.io/principal' },
        publisher: { '@type': 'Person', name: 'Richard Ewing' },
        url: 'https://www.richardewing.io/guides/startup-cto-handbook',
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://www.richardewing.io/guides/startup-cto-handbook' },
    };
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'The Startup CTO Handbook', item: 'https://www.richardewing.io/guides/startup-cto-handbook' },
        ],
    };
    const speakableSchema = {
        '@context': 'https://schema.org', '@type': 'WebPage',
        name: 'The Startup CTO Handbook',
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-[10px] font-mono text-zinc-600 uppercase tracking-widest">
                        <Link href="/guides" className="hover:text-cyan-400">Guides</Link><span>/</span><span className="text-cyan-400 font-bold">The Startup CTO Handbook</span>
                    </div>
                    <h1 className="text-4xl sm:text-5xl font-grotesk font-bold text-white mb-6">
                        The Startup CTO{' '}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-amber-400">Handbook</span>
                    </h1>
                    <p className="text-lg text-zinc-400 mb-4 max-w-2xl">First Commit to Series B. A comprehensive engineering economics guide.</p>
                    ...
                    <div className="rounded-2xl border border-cyan-500/30 bg-cyan-500/5 p-8 mb-16">
                        ...
                        <Link href="/advisory" className="inline-block px-8 py-4 rounded-lg bg-gradient-to-r from-cyan-500 to-amber-500 text-white font-bold hover:opacity-90 transition-opacity">Book an R&D Capital Audit \u2192</Link>
                    </div>
                <RelatedContent currentSlug="startup-cto-handbook" type="guide" count={3} />
                    </div>
                </div>
            </main>
    );
