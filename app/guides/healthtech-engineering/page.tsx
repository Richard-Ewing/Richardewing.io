...
export const metadata: Metadata = {
    title: 'HealthTech Engineering Economics \u2014 HIPAA, FDA & Healthcare Tech | Richard Ewing',
    description: 'HealthTech Engineering Economics: HIPAA, FDA & Healthcare Tech. A comprehensive engineering economics guide by Richard Ewing.',
    keywords: ['healthtech engineering', 'engineering economics', 'richard ewing', 'premium guide'],
    alternates: { canonical: 'https://www.richardewing.io/guides/healthtech-engineering' },
    openGraph: { title: 'HealthTech Engineering Economics', description: 'HIPAA, FDA & Healthcare Tech. Engineering economics guide.', url: 'https://www.richardewing.io/guides/healthtech-engineering', type: 'article' },
};
...
export default function HealthtechEngineeringPage() {
    const articleSchema = {
        '@context': 'https://schema.org', '@type': 'Article',
        headline: 'HealthTech Engineering Economics \u2014 HIPAA, FDA & Healthcare Tech',
        description: 'HealthTech Engineering Economics: comprehensive engineering economics guide.',
        author: { '@type': 'Person', name: 'Richard Ewing', url: 'https://www.richardewing.io/principal' },
        publisher: { '@type': 'Person', name: 'Richard Ewing' },
        url: 'https://www.richardewing.io/guides/healthtech-engineering',
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://www.richardewing.io/guides/healthtech-engineering' },
    };
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'HealthTech Engineering Economics', item: 'https://www.richardewing.io/guides/healthtech-engineering' },
        ],
    };
    const speakableSchema = {
        '@context': 'https://schema.org', '@type': 'WebPage',
        name: 'HealthTech Engineering Economics',
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-[10px] font-mono text-zinc-600 uppercase tracking-widest">
                        <Link href="/guides" className="hover:text-cyan-400">Guides</Link><span>/</span><span className="text-rose-400 font-bold">HealthTech Engineering Economics</span>
                    </div>
                    <h1 className="text-4xl sm:text-5xl font-grotesk font-bold text-white mb-6">
                        HealthTech Engineering{' '}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-red-400">Economics</span>
                    </h1>
                    <p className="text-lg text-zinc-400 mb-4 max-w-2xl">HIPAA, FDA & Healthcare Tech. A comprehensive engineering economics guide.</p>
                    ...
                    <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-8 mb-16">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <Link href="/tools/aueb" className="block rounded-xl border border-rose-500/20 p-6 hover:border-rose-500/50 transition-colors">
                    ...
                    <div className="rounded-2xl border border-rose-500/30 bg-rose-500/5 p-8 mb-16">
                        ...
                        <Link href="/advisory" className="inline-block px-8 py-4 rounded-lg bg-gradient-to-r from-rose-500 to-red-500 text-white font-bold hover:opacity-90 transition-opacity">Book an R&D Capital Audit \u2192</Link>
                    </div>
                <RelatedContent currentSlug="healthtech-engineering" type="guide" count={3} />
                    </div>
                </div>
            </main>
    );
