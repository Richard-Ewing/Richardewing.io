...
export const metadata: Metadata = {
    title: 'Engineering Team Scaling (30 to 100) \u2014 Growth-Stage Operating Manual | Richard Ewing',
    description: 'Engineering Team Scaling (30 to 100): Growth-Stage Operating Manual. A comprehensive engineering economics guide by Richard Ewing.',
    keywords: ['engineering scaling 30 100', 'engineering economics', 'richard ewing', 'premium guide'],
    alternates: { canonical: 'https://www.richardewing.io/guides/engineering-scaling-30-100' },
    openGraph: { title: 'Engineering Team Scaling (30 to 100)', description: 'Growth-Stage Operating Manual. Engineering economics guide.', url: 'https://www.richardewing.io/guides/engineering-scaling-30-100', type: 'article' },
};
...
export default function EngineeringScaling30100Page() {
    const articleSchema = {
        '@context': 'https://schema.org', '@type': 'Article',
        headline: 'Engineering Team Scaling (30 to 100) \u2014 Growth-Stage Operating Manual',
        description: 'Engineering Team Scaling (30 to 100): comprehensive engineering economics guide.',
        author: { '@type': 'Person', name: 'Richard Ewing', url: 'https://www.richardewing.io/principal' },
        publisher: { '@type': 'Person', name: 'Richard Ewing' },
        url: 'https://www.richardewing.io/guides/engineering-scaling-30-100',
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://www.richardewing.io/guides/engineering-scaling-30-100' },
    };
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'Engineering Team Scaling (30 to 100)', item: 'https://www.richardewing.io/guides/engineering-scaling-30-100' },
        ],
    };
    const speakableSchema = {
        '@context': 'https://schema.org', '@type': 'WebPage',
        name: 'Engineering Team Scaling (30 to 100)',
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-[10px] font-mono text-zinc-600 uppercase tracking-widest">
                        <Link href="/guides" className="hover:text-cyan-400">Guides</Link><span>/</span><span className="text-amber-400 font-bold">Engineering Team Scaling (30 to 100)</span>
                    </div>
                    <h1 className="text-4xl sm:text-5xl font-grotesk font-bold text-white mb-6">
                        Engineering Team Scaling (30 to{' '}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-violet-400">100)</span>
                    </h1>
                    <p className="text-lg text-zinc-400 mb-4 max-w-2xl">Growth-Stage Operating Manual. A comprehensive engineering economics guide.</p>
                    ...
                    <div className="rounded-2xl border border-amber-500/30 bg-amber-500/5 p-8 mb-16">
                        ...
                        <Link href="/advisory" className="inline-block px-8 py-4 rounded-lg bg-gradient-to-r from-amber-500 to-violet-500 text-white font-bold hover:opacity-90 transition-opacity">Book an R&D Capital Audit \u2192</Link>
                    </div>
                <RelatedContent currentSlug="engineering-scaling-30-100" type="guide" count={3} />
                    </div>
                </div>
            </main>
    );
