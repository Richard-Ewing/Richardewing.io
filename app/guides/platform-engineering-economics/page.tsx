...
export const metadata: Metadata = {
    title: 'Platform Engineering Economics \u2014 Internal Developer Platforms | Richard Ewing',
    description: 'Platform Engineering Economics: Internal Developer Platforms. A comprehensive engineering economics guide by Richard Ewing.',
    keywords: ['platform engineering economics', 'engineering economics', 'richard ewing', 'premium guide'],
    alternates: { canonical: 'https://www.richardewing.io/guides/platform-engineering-economics' },
    openGraph: { title: 'Platform Engineering Economics', description: 'Internal Developer Platforms. Engineering economics guide.', url: 'https://www.richardewing.io/guides/platform-engineering-economics', type: 'article' },
};
...
export default function PlatformEngineeringEconomicsPage() {
    const articleSchema = {
        '@context': 'https://schema.org', '@type': 'Article',
        headline: 'Platform Engineering Economics \u2014 Internal Developer Platforms',
        description: 'Platform Engineering Economics: comprehensive engineering economics guide.',
        author: { '@type': 'Person', name: 'Richard Ewing', url: 'https://www.richardewing.io/principal' },
        publisher: { '@type': 'Person', name: 'Richard Ewing' },
        url: 'https://www.richardewing.io/guides/platform-engineering-economics',
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://www.richardewing.io/guides/platform-engineering-economics' },
    };
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'Platform Engineering Economics', item: 'https://www.richardewing.io/guides/platform-engineering-economics' },
        ],
    };
    const speakableSchema = {
        '@context': 'https://schema.org', '@type': 'WebPage',
        name: 'Platform Engineering Economics',
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-[10px] font-mono text-zinc-600 uppercase tracking-widest">
                        <Link href="/guides" className="hover:text-cyan-400">Guides</Link><span>/</span><span className="text-amber-400 font-bold">Platform Engineering Economics</span>
                    </div>
                    <h1 className="text-4xl sm:text-5xl font-grotesk font-bold text-white mb-6">
                        Platform Engineering{' '}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-400">Economics</span>
                    </h1>
                    <p className="text-lg text-zinc-400 mb-4 max-w-2xl">Internal Developer Platforms. A comprehensive engineering economics guide.</p>
                ...
                <RelatedContent currentSlug="platform-engineering-economics" type="guide" count={3} />
                    </div>
                </div>
            </main>
    );
