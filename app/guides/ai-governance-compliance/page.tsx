...
export const metadata: Metadata = {
    title: 'AI Governance & Compliance \u2014 NIST AI RMF to Board Reporting | Richard Ewing',
    description: 'AI Governance & Compliance: NIST AI RMF to Board Reporting. A comprehensive engineering economics guide by Richard Ewing.',
    keywords: ['ai governance compliance', 'engineering economics', 'richard ewing', 'premium guide'],
    alternates: { canonical: 'https://www.richardewing.io/guides/ai-governance-compliance' },
    openGraph: { title: 'AI Governance & Compliance', description: 'NIST AI RMF to Board Reporting. Engineering economics guide.', url: 'https://www.richardewing.io/guides/ai-governance-compliance', type: 'article' },
};
...
export default function AiGovernanceCompliancePage() {
    const articleSchema = {
        ...
        headline: 'AI Governance & Compliance \u2014 NIST AI RMF to Board Reporting',
        description: 'AI Governance & Compliance: comprehensive engineering economics guide.',
        author: { '@type': 'Person', name: 'Richard Ewing', url: 'https://www.richardewing.io/principal' },
        publisher: { '@type': 'Person', name: 'Richard Ewing' },
        url: 'https://www.richardewing.io/guides/ai-governance-compliance',
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://www.richardewing.io/guides/ai-governance-compliance' },
    };
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'AI Governance & Compliance', item: 'https://www.richardewing.io/guides/ai-governance-compliance' },
        ],
    };
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-[10px] font-mono text-zinc-600 uppercase tracking-widest">
                        <Link href="/guides" className="hover:text-cyan-400">Guides</Link><span>/</span><span className="text-violet-400 font-bold">AI Governance & Compliance</span>
                    </div>
                    <h1 className="text-4xl sm:text-5xl font-grotesk font-bold text-white mb-6">
                        AI Governance &{' '}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-blue-400">Compliance</span>
                    </h1>
                    <p className="text-lg text-zinc-400 mb-4 max-w-2xl">NIST AI RMF to Board Reporting. A comprehensive engineering economics guide.</p>
                    ...
                    <div className="rounded-2xl border border-violet-500/30 bg-violet-500/5 p-8 mb-16">
                        ...
                        <Link href="/advisory" className="inline-block px-8 py-4 rounded-lg bg-gradient-to-r from-violet-500 to-blue-500 text-white font-bold hover:opacity-90 transition-opacity">Book an R&D Capital Audit \u2192</Link>
                    </div>
                <RelatedContent currentSlug="ai-governance-compliance" type="guide" count={3} />
                    </div>
                </div>
            </main>
    );
