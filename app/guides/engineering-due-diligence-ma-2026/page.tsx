...
export default async function EngineeringDueDiligence2026Page() {
    const articleSchema = {
...
<GuidePayGate guideTitle="Engineering Due Diligence for M&A 2026" productId="guide_eng_due_diligence_2026" hasAccess={hasAccess}>
