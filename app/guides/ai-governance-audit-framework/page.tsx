...
export const metadata: Metadata = {
    ...
    description: 'AI Governance & Audit Framework: EU AI Act Compliance, Risk Assessment, and Audit Playbook. A comprehensive engineering economics guide by Richard Ewing.',
    keywords: ['ai', 'governance', 'audit', 'framework', 'engineering economics', 'richard ewing'],
    alternates: { canonical: 'https://www.richardewing.io/guides/ai-governance-audit-framework' },
    openGraph: { title: 'AI Governance & Audit Framework', description: 'EU AI Act Compliance, Risk Assessment, and Audit Playbook. Engineering economics guide.', url: 'https://www.richardewing.io/guides/ai-governance-audit-framework', type: 'article' },
};

const sections = [
    {
        title: 'EU AI Act Risk Classification',
        description: 'Determining your AI system\u0027s risk category and obligations',
        slugs: ["technical-debt", "architecture-debt", "infrastructure-debt", "code-smell", "documentation-debt"],
        color: 'amber',
    },
    {
        title: 'Model Audit Methodology',
        description: 'Testing, validation, and bias assessment frameworks',
        slugs: ["test-debt", "change-failure-rate", "mean-time-to-recovery", "deployment-frequency", "feature-velocity"],
        color: 'violet',
    },
    {
        title: 'Compliance Cost Modeling',
        description: 'Budgeting for AI governance implementation',
        slugs: ["capex-vs-opex", "total-cost-of-ownership", "innovation-tax", "maintenance-load", "engineering-economics"],
        color: 'cyan',
    },
    {
        title: '90-Day Implementation Plan',
        description: 'From assessment to compliant AI governance',
        slugs: ["build-vs-buy", "vendor-lock-in", "platform-engineering", "engineering-roi", "r-and-d-capitalization"],
        color: 'emerald',
    },
];
...
export default function AiGovernanceFrameworkPage() {
    const articleSchema = {
        ...
        description: 'AI Governance & Audit Framework: comprehensive engineering economics guide.',
        ...
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://www.richardewing.io/guides/ai-governance-audit-framework' },
    };
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'AI Governance & Audit Framework', item: 'https://www.richardewing.io/guides/ai-governance-audit-framework' },
        ],
    };
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-[10px] font-mono text-zinc-600 uppercase tracking-widest">
                        <Link href="/guides" className="hover:text-cyan-400">Guides</Link><span>/</span><span className="text-cyan-400 font-bold">AI Governance & Audit Framework</span>
                    </div>
                    <h1 className="text-4xl sm:text-5xl font-grotesk font-bold text-white mb-6">
                        AI Governance & Audit{' '}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-400">Framework</span>
                    </h1>
