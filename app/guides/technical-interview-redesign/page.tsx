...
export const metadata: Metadata = {
    title: 'Technical Interview Redesign \u2014 Test Judgment Not Syntax | Richard Ewing',
    description: 'Technical Interview Redesign: Test Judgment Not Syntax. A comprehensive engineering economics guide by Richard Ewing.',
    keywords: ['technical interview redesign', 'engineering economics', 'richard ewing', 'premium guide'],
    alternates: { canonical: 'https://www.richardewing.io/guides/technical-interview-redesign' },
    openGraph: { title: 'Technical Interview Redesign', description: 'Test Judgment Not Syntax. Engineering economics guide.', url: 'https://www.richardewing.io/guides/technical-interview-redesign', type: 'article' },
};
...
export default function TechnicalInterviewRedesignPage() {
    const articleSchema = {
        '@context': 'https://schema.org', '@type': 'Article',
        headline: 'Technical Interview Redesign \u2014 Test Judgment Not Syntax',
        description: 'Technical Interview Redesign: comprehensive engineering economics guide.',
        author: { '@type': 'Person', name: 'Richard Ewing', url: 'https://www.richardewing.io/principal' },
        publisher: { '@type': 'Person', name: 'Richard Ewing' },
        url: 'https://www.richardewing.io/guides/technical-interview-redesign',
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://www.richardewing.io/guides/technical-interview-redesign' },
    };
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'Technical Interview Redesign', item: 'https://www.richardewing.io/guides/technical-interview-redesign' },
        ],
    };
    const speakableSchema = {
        '@context': 'https://schema.org', '@type': 'WebPage',
        name: 'Technical Interview Redesign',
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-[10px] font-mono text-zinc-600 uppercase tracking-widest">
                        <Link href="/guides" className="hover:text-cyan-400">Guides</Link><span>/</span><span className="text-emerald-400 font-bold">Technical Interview Redesign</span>
                    </div>
                    <h1 className="text-4xl sm:text-5xl font-grotesk font-bold text-white mb-6">
                        Technical Interview{' '}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400">Redesign</span>
                    </h1>
                    <p className="text-lg text-zinc-400 mb-4 max-w-2xl">Test Judgment Not Syntax. A comprehensive engineering economics guide.</p>
                ...
                <RelatedContent currentSlug="technical-interview-redesign" type="guide" count={3} />
                    </div>
                </div>
            </main>
    );
