...
export const metadata: Metadata = {
    title: 'Engineering Org Design \u2014 From 10 to 500 Engineers | Richard Ewing',
    description: 'Engineering Org Design: From 10 to 500 Engineers. A comprehensive engineering economics guide by Richard Ewing.',
    keywords: ['engineering org design', 'engineering economics', 'richard ewing', 'premium guide'],
    alternates: { canonical: 'https://www.richardewing.io/guides/engineering-org-design' },
    openGraph: { title: 'Engineering Org Design', description: 'From 10 to 500 Engineers. Engineering economics guide.', url: 'https://www.richardewing.io/guides/engineering-org-design', type: 'article' },
};
...
export default function EngineeringOrgDesignPage() {
    const articleSchema = {
        '@context': 'https://schema.org', '@type': 'Article',
        headline: 'Engineering Org Design \u2014 From 10 to 500 Engineers',
        description: 'Engineering Org Design: comprehensive engineering economics guide.',
        author: { '@type': 'Person', name: 'Richard Ewing', url: 'https://www.richardewing.io/principal' },
        publisher: { '@type': 'Person', name: 'Richard Ewing' },
        url: 'https://www.richardewing.io/guides/engineering-org-design',
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://www.richardewing.io/guides/engineering-org-design' },
    };
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'Engineering Org Design', item: 'https://www.richardewing.io/guides/engineering-org-design' },
        ],
    };
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-[10px] font-mono text-zinc-600 uppercase tracking-widest">
                        <Link href="/guides" className="hover:text-cyan-400">Guides</Link><span>/</span><span className="text-violet-400 font-bold">Engineering Org Design</span>
                    </div>
                    <h1 className="text-4xl sm:text-5xl font-grotesk font-bold text-white mb-6">
                        Engineering Org{' '}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-cyan-400">Design</span>
                    </h1>
                    <p className="text-lg text-zinc-400 mb-4 max-w-2xl">From 10 to 500 Engineers. A comprehensive engineering economics guide.</p>
                    ...
                    <div className="rounded-2xl border border-violet-500/30 bg-violet-500/5 p-8 mb-16">
                        ...
                        <Link href="/advisory" className="inline-block px-8 py-4 rounded-lg bg-gradient-to-r from-violet-500 to-cyan-500 text-white font-bold hover:opacity-90 transition-opacity">Book an R&D Capital Audit \u2192</Link>
                    </div>
                <RelatedContent currentSlug="engineering-org-design" type="guide" count={3} />
                    </div>
                </div>
            </main>
    );
