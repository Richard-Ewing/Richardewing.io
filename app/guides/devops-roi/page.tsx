...
export const metadata: Metadata = {
    title: 'DevOps ROI Playbook \u2014 Quantifying DevOps Investment | Richard Ewing',
    description: 'DevOps ROI Playbook: Quantifying DevOps Investment. A comprehensive engineering economics guide by Richard Ewing.',
    keywords: ['devops roi', 'engineering economics', 'richard ewing', 'free guide'],
    alternates: { canonical: 'https://www.richardewing.io/guides/devops-roi' },
    openGraph: { title: 'DevOps ROI Playbook', description: 'Quantifying DevOps Investment. Engineering economics guide.', url: 'https://www.richardewing.io/guides/devops-roi', type: 'article' },
};

const sections = [
    {
        "title": "DORA Metrics Framework",
        "description": "The four pillars of delivery performance",
        "slugs": [
    ...
    {
        "title": "CI/CD Pipeline Economics",
        "description": "Pipeline investment and returns",
        "slugs": [
            "technical-debt",
            "test-debt",
            "infrastructure-debt",
    ...
    },
    {
        ...
        "description": "Monitoring and alerting ROI",
        "slugs": [
            "architecture-debt",
            "dependency-debt",
            "legacy-code",
    ...
    },
    {
        ...
        "description": "12-month capability roadmap",
        "slugs": [
            "innovation-tax",
            "maintenance-load",
...
export default function DevopsRoiPage() {
    const articleSchema = {
        '@context': 'https://schema.org', '@type': 'Article',
        headline: 'DevOps ROI Playbook \u2014 Quantifying DevOps Investment',
        description: 'DevOps ROI Playbook: comprehensive engineering economics guide.',
        author: { '@type': 'Person', name: 'Richard Ewing', url: 'https://www.richardewing.io/principal' },
        publisher: { '@type': 'Person', name: 'Richard Ewing' },
        url: 'https://www.richardewing.io/guides/devops-roi',
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://www.richardewing.io/guides/devops-roi' },
    };
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'DevOps ROI Playbook', item: 'https://www.richardewing.io/guides/devops-roi' },
        ],
    };
    const speakableSchema = {
        '@context': 'https://schema.org', '@type': 'WebPage',
        name: 'DevOps ROI Playbook',
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-[10px] font-mono text-zinc-600 uppercase tracking-widest">
                        <Link href="/guides" className="hover:text-cyan-400">Guides</Link><span>/</span><span className="text-cyan-400 font-bold">DevOps ROI Playbook</span>
                    </div>
                    <h1 className="text-4xl sm:text-5xl font-grotesk font-bold text-white mb-6">
                        DevOps ROI{' '}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-emerald-400">Playbook</span>
                    </h1>
                    <p className="text-lg text-zinc-400 mb-4 max-w-2xl">Quantifying DevOps Investment. A comprehensive engineering economics guide.</p>
                    ...
                    <div className="rounded-2xl border border-cyan-500/30 bg-cyan-500/5 p-8 mb-16">
                        ...
                        <Link href="/advisory" className="inline-block px-8 py-4 rounded-lg bg-gradient-to-r from-cyan-500 to-emerald-500 text-white font-bold hover:opacity-90 transition-opacity">Book an R&D Capital Audit \u2192</Link>
                    </div>
                <RelatedContent currentSlug="devops-roi" type="guide" count={3} />
                    </div>
                </div>
            </main>
    );
