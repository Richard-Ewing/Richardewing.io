...
export const metadata: Metadata = {
    title: 'The API Monetization Playbook \u2014 From Internal API to Revenue | Richard Ewing',
    description: 'The API Monetization Playbook: From Internal API to Revenue. A comprehensive engineering economics guide by Richard Ewing.',
    keywords: ['api monetization', 'engineering economics', 'richard ewing', 'free guide'],
    alternates: { canonical: 'https://www.richardewing.io/guides/api-monetization' },
    openGraph: { title: 'The API Monetization Playbook', description: 'From Internal API to Revenue. Engineering economics guide.', url: 'https://www.richardewing.io/guides/api-monetization', type: 'article' },
};
...
export default function ApiMonetizationPage() {
    const articleSchema = {
        ...
        headline: 'The API Monetization Playbook \u2014 From Internal API to Revenue',
        description: 'The API Monetization Playbook: comprehensive engineering economics guide.',
        author: { '@type': 'Person', name: 'Richard Ewing', url: 'https://www.richardewing.io/principal' },
        publisher: { '@type': 'Person', name: 'Richard Ewing' },
        url: 'https://www.richardewing.io/guides/api-monetization',
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://www.richardewing.io/guides/api-monetization' },
    };
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'The API Monetization Playbook', item: 'https://www.richardewing.io/guides/api-monetization' },
        ],
    };
    const speakableSchema = {
        '@context': 'https://schema.org', '@type': 'WebPage',
        name: 'The API Monetization Playbook',
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-[10px] font-mono text-zinc-600 uppercase tracking-widest">
                        <Link href="/guides" className="hover:text-cyan-400">Guides</Link><span>/</span><span className="text-emerald-400 font-bold">The API Monetization Playbook</span>
                    </div>
                    <h1 className="text-4xl sm:text-5xl font-grotesk font-bold text-white mb-6">
                        The API Monetization{' '}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400">Playbook</span>
                    </h1>
                    <p className="text-lg text-zinc-400 mb-4 max-w-2xl">From Internal API to Revenue. A comprehensive engineering economics guide.</p>
                ...
                <RelatedContent currentSlug="api-monetization" type="guide" count={3} />
                    </div>
                </div>
            </main>
    );
