...
export const metadata: Metadata = {
    title: 'Cybersecurity Economics Playbook \u2014 Quantify Risk, Justify Budget, and Prioritize Investments | Richard Ewing',
    description: 'Cybersecurity Economics Playbook: Quantify Risk, Justify Budget, and Prioritize Investments. A comprehensive engineering economics guide by Richard Ewing.',
    keywords: ['cybersecurity', 'economics', 'playbook', 'engineering economics', 'richard ewing'],
    alternates: { canonical: 'https://www.richardewing.io/guides/cybersecurity-economics-playbook' },
    openGraph: { title: 'Cybersecurity Economics Playbook', description: 'Quantify Risk, Justify Budget, and Prioritize Investments. Engineering economics guide.', url: 'https://www.richardewing.io/guides/cybersecurity-economics-playbook', type: 'article' },
};

const sections = [
    {
        title: 'Breach Cost Modeling',
        description: 'Quantifying the financial impact of security incidents',
        slugs: ["total-cost-of-ownership", "technical-debt", "infrastructure-debt", "maintenance-load", "engineering-economics"],
        color: 'red',
    },
    {
        title: 'Security ROI Calculation',
        description: 'Proving the value of security investments to the board',
        slugs: ["capex-vs-opex", "innovation-tax", "engineering-roi", "r-and-d-capitalization", "revenue-per-engineer"],
        color: 'amber',
    },
    {
        title: 'Zero-Trust Economics',
        description: 'Implementation costs, timelines, and expected returns',
        slugs: ["architecture-debt", "platform-engineering", "vendor-lock-in", "build-vs-buy", "deployment-frequency"],
        color: 'violet',
    },
    {
        title: 'Board-Ready Business Case',
        description: 'Presenting cybersecurity as business investment',
        slugs: ["product-debt-index", "unit-economics", "feature-velocity", "lead-time", "change-failure-rate"],
        color: 'cyan',
    },
];
...
export default async function CybersecurityEconomicsPage() {
    const articleSchema = {
        '@context': 'https://schema.org', '@type': 'Article',
        headline: 'Cybersecurity Economics Playbook \u2014 Quantify Risk, Justify Budget, and Prioritize Investments',
        description: 'Cybersecurity Economics Playbook: comprehensive engineering economics guide.',
        author: { '@type': 'Person', name: 'Richard Ewing', url: 'https://www.richardewing.io/principal' },
        publisher: { '@type': 'Person', name: 'Richard Ewing' },
        url: 'https://www.richardewing.io/guides/cybersecurity-economics-playbook',
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://www.richardewing.io/guides/cybersecurity-economics-playbook' },
    };
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'Cybersecurity Economics Playbook', item: 'https://www.richardewing.io/guides/cybersecurity-economics-playbook' },
        ],
    };
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-[10px] font-mono text-zinc-600 uppercase tracking-widest">
                        <Link href="/guides" className="hover:text-cyan-400">Guides</Link><span>/</span><span className="text-cyan-400 font-bold">Cybersecurity Economics Playbook</span>
                    </div>
                    <h1 className="text-4xl sm:text-5xl font-grotesk font-bold text-white mb-6">
                        Cybersecurity Economics{' '}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-amber-400">Playbook</span>
                    </h1>
                    <p className="text-lg text-zinc-400 mb-4 max-w-2xl">Quantify Risk, Justify Budget, and Prioritize Investments. A comprehensive engineering economics guide.</p>
                    <p className="text-sm text-zinc-500 mb-12">A pillar resource with linked glossary terms, tools, and frameworks.</p>

                    
<GuidePayGate guideTitle="Cybersecurity Economics Playbook" productId="guide_cybersecurity_economics" hasAccess={hasAccess}>
...
<RelatedContent currentSlug="cybersecurity-economics-playbook" type="guide" count={3} />
                    </div>
                </div>
            </main>
    );
