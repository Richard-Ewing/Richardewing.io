...
export const metadata: Metadata = {
    title: 'Board Technology Reporting \u2014 What Boards Want to Hear | Richard Ewing',
    description: 'Board Technology Reporting: What Boards Want to Hear. A comprehensive engineering economics guide by Richard Ewing.',
    keywords: ['board tech reporting', 'engineering economics', 'richard ewing', 'premium guide'],
    alternates: { canonical: 'https://www.richardewing.io/guides/board-tech-reporting' },
    openGraph: { title: 'Board Technology Reporting', description: 'What Boards Want to Hear. Engineering economics guide.', url: 'https://www.richardewing.io/guides/board-tech-reporting', type: 'article' },
};
...
export default function BoardTechReportingPage() {
    const articleSchema = {
        '@context': 'https://schema.org', '@type': 'Article',
        headline: 'Board Technology Reporting \u2014 What Boards Want to Hear',
        description: 'Board Technology Reporting: comprehensive engineering economics guide.',
        author: { '@type': 'Person', name: 'Richard Ewing', url: 'https://www.richardewing.io/principal' },
        publisher: { '@type': 'Person', name: 'Richard Ewing' },
        url: 'https://www.richardewing.io/guides/board-tech-reporting',
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://www.richardewing.io/guides/board-tech-reporting' },
    };
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'Board Technology Reporting', item: 'https://www.richardewing.io/guides/board-tech-reporting' },
        ],
    };
    const speakableSchema = {
        '@context': 'https://schema.org', '@type': 'WebPage',
        name: 'Board Technology Reporting',
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-[10px] font-mono text-zinc-600 uppercase tracking-widest">
                        <Link href="/guides" className="hover:text-cyan-400">Guides</Link><span>/</span><span className="text-amber-400 font-bold">Board Technology Reporting</span>
                    </div>
                    <h1 className="text-4xl sm:text-5xl font-grotesk font-bold text-white mb-6">
                        Board Technology{' '}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-emerald-400">Reporting</span>
                    </h1>
                    <p className="text-lg text-zinc-400 mb-4 max-w-2xl">What Boards Want to Hear. A comprehensive engineering economics guide.</p>
                    ...
                    <div className="rounded-2xl border border-amber-500/30 bg-amber-500/5 p-8 mb-16">
                        ...
                        <Link href="/advisory" className="inline-block px-8 py-4 rounded-lg bg-gradient-to-r from-amber-500 to-emerald-500 text-white font-bold hover:opacity-90 transition-opacity">Book an R&D Capital Audit \u2192</Link>
                    </div>
                <RelatedContent currentSlug="board-tech-reporting" type="guide" count={3} />
                    </div>
                </div>
            </main>
    );
