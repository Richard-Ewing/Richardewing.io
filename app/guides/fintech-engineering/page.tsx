...
export const metadata: Metadata = {
    title: 'FinTech Engineering Economics \u2014 SOX, PCI & Financial Software | Richard Ewing',
    description: 'FinTech Engineering Economics: SOX, PCI & Financial Software. A comprehensive engineering economics guide by Richard Ewing.',
    keywords: ['fintech engineering', 'engineering economics', 'richard ewing', 'premium guide'],
    alternates: { canonical: 'https://www.richardewing.io/guides/fintech-engineering' },
    openGraph: { title: 'FinTech Engineering Economics', description: 'SOX, PCI & Financial Software. Engineering economics guide.', url: 'https://www.richardewing.io/guides/fintech-engineering', type: 'article' },
};
...
export default function FintechEngineeringPage() {
    const articleSchema = {
        '@context': 'https://schema.org', '@type': 'Article',
        headline: 'FinTech Engineering Economics \u2014 SOX, PCI & Financial Software',
        description: 'FinTech Engineering Economics: comprehensive engineering economics guide.',
        author: { '@type': 'Person', name: 'Richard Ewing', url: 'https://www.richardewing.io/principal' },
        publisher: { '@type': 'Person', name: 'Richard Ewing' },
        url: 'https://www.richardewing.io/guides/fintech-engineering',
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://www.richardewing.io/guides/fintech-engineering' },
    };
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'FinTech Engineering Economics', item: 'https://www.richardewing.io/guides/fintech-engineering' },
        ],
    };
    const speakableSchema = {
        '@context': 'https://schema.org', '@type': 'WebPage',
        name: 'FinTech Engineering Economics',
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-[10px] font-mono text-zinc-600 uppercase tracking-widest">
                        <Link href="/guides" className="hover:text-cyan-400">Guides</Link><span>/</span><span className="text-amber-400 font-bold">FinTech Engineering Economics</span>
                    </div>
                    <h1 className="text-4xl sm:text-5xl font-grotesk font-bold text-white mb-6">
                        FinTech Engineering{' '}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-red-400">Economics</span>
                    </h1>
                    <p className="text-lg text-zinc-400 mb-4 max-w-2xl">SOX, PCI & Financial Software. A comprehensive engineering economics guide.</p>
                    ...
                    <div className="rounded-2xl border border-amber-500/30 bg-amber-500/5 p-8 mb-16">
                        ...
                        <Link href="/advisory" className="inline-block px-8 py-4 rounded-lg bg-gradient-to-r from-amber-500 to-red-500 text-white font-bold hover:opacity-90 transition-opacity">Book an R&D Capital Audit \u2192</Link>
                    </div>
                <RelatedContent currentSlug="fintech-engineering" type="guide" count={3} />
                    </div>
                </div>
            </main>
    );
