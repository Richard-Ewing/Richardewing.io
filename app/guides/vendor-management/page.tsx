...
export const metadata: Metadata = {
    title: 'Vendor Management & Contract Negotiation \u2014 Save 20-40% on Software Spend | Richard Ewing',
    description: 'Vendor Management & Contract Negotiation: Save 20-40% on Software Spend. A comprehensive engineering economics guide by Richard Ewing.',
    keywords: ['vendor management', 'engineering economics', 'richard ewing', 'premium guide'],
    alternates: { canonical: 'https://www.richardewing.io/guides/vendor-management' },
    openGraph: { title: 'Vendor Management & Contract Negotiation', description: 'Save 20-40% on Software Spend. Engineering economics guide.', url: 'https://www.richardewing.io/guides/vendor-management', type: 'article' },
};
...
export default function VendorManagementPage() {
    const articleSchema = {
        ...
        headline: 'Vendor Management & Contract Negotiation \u2014 Save 20-40% on Software Spend',
        description: 'Vendor Management & Contract Negotiation: comprehensive engineering economics guide.',
        author: { '@type': 'Person', name: 'Richard Ewing', url: 'https://www.richardewing.io/principal' },
        publisher: { '@type': 'Person', name: 'Richard Ewing' },
        url: 'https://www.richardewing.io/guides/vendor-management',
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://www.richardewing.io/guides/vendor-management' },
    };
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'Vendor Management & Contract Negotiation', item: 'https://www.richardewing.io/guides/vendor-management' },
        ],
    };
    const speakableSchema = {
        '@context': 'https://schema.org', '@type': 'WebPage',
        name: 'Vendor Management & Contract Negotiation',
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-[10px] font-mono text-zinc-600 uppercase tracking-widest">
                        <Link href="/guides" className="hover:text-cyan-400">Guides</Link><span>/</span><span className="text-emerald-400 font-bold">Vendor Management & Contract Negotiation</span>
                    </div>
                    <h1 className="text-4xl sm:text-5xl font-grotesk font-bold text-white mb-6">
                        Vendor Management & Contract{' '}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-amber-400">Negotiation</span>
                    </h1>
                    <p className="text-lg text-zinc-400 mb-4 max-w-2xl">Save 20-40% on Software Spend. A comprehensive engineering economics guide.</p>
                    ...
                    <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-8 mb-16">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <Link href="/tools/aueb" className="block rounded-xl border border-emerald-500/20 p-6 hover:border-emerald-500/50 transition-colors">
                    ...
                    <div className="rounded-2xl border border-emerald-500/30 bg-emerald-500/5 p-8 mb-16">
                        ...
                        <Link href="/advisory" className="inline-block px-8 py-4 rounded-lg bg-gradient-to-r from-emerald-500 to-amber-500 text-white font-bold hover:opacity-90 transition-opacity">Book an R&D Capital Audit \u2192</Link>
                    </div>
                <RelatedContent currentSlug="vendor-management" type="guide" count={3} />
                    </div>
                </div>
            </main>
    );
