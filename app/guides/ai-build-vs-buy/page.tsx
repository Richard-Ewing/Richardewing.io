...
export const metadata: Metadata = {
    title: 'AI Build vs. Buy Decision Framework \u2014 When to Build AI In-House | Richard Ewing',
    description: 'AI Build vs. Buy Decision Framework: When to Build AI In-House. A comprehensive engineering economics guide by Richard Ewing.',
    keywords: ['ai build vs buy', 'engineering economics', 'richard ewing', 'premium guide'],
    alternates: { canonical: 'https://www.richardewing.io/guides/ai-build-vs-buy' },
    openGraph: { title: 'AI Build vs. Buy Decision Framework', description: 'When to Build AI In-House. Engineering economics guide.', url: 'https://www.richardewing.io/guides/ai-build-vs-buy', type: 'article' },
};
...
export default function AiBuildVsBuyPage() {
    const articleSchema = {
        '@context': 'https://schema.org', '@type': 'Article',
        headline: 'AI Build vs. Buy Decision Framework \u2014 When to Build AI In-House',
        description: 'AI Build vs. Buy Decision Framework: comprehensive engineering economics guide.',
        author: { '@type': 'Person', name: 'Richard Ewing', url: 'https://www.richardewing.io/principal' },
        publisher: { '@type': 'Person', name: 'Richard Ewing' },
        url: 'https://www.richardewing.io/guides/ai-build-vs-buy',
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://www.richardewing.io/guides/ai-build-vs-buy' },
    };
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'AI Build vs. Buy Decision Framework', item: 'https://www.richardewing.io/guides/ai-build-vs-buy' },
        ],
    };
    const speakableSchema = {
        '@context': 'https://schema.org', '@type': 'WebPage',
        name: 'AI Build vs. Buy Decision Framework',
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-[10px] font-mono text-zinc-600 uppercase tracking-widest">
                        <Link href="/guides" className="hover:text-cyan-400">Guides</Link><span>/</span><span className="text-cyan-400 font-bold">AI Build vs. Buy Decision Framework</span>
                    </div>
                    <h1 className="text-4xl sm:text-5xl font-grotesk font-bold text-white mb-6">
                        AI Build vs. Buy Decision{' '}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-violet-400">Framework</span>
                    </h1>
                    <p className="text-lg text-zinc-400 mb-4 max-w-2xl">When to Build AI In-House. A comprehensive engineering economics guide.</p>
                ...
                <RelatedContent currentSlug="ai-build-vs-buy" type="guide" count={3} />
                    </div>
                </div>
            </main>
    );
