...
export const metadata: Metadata = {
    title: 'Live AI Governance Telemetry',
    description: 'Real-time benchmark telemetry analyzing AI cost overruns, retry loop frequencies, and context drift across enterprise stacks.',
