...
const CMAP: Record<string, { bg: string, text: string, border: string, shadow: string, hoverBg: string, bg10: string }> = {
    ...
    fuchsia: { bg: 'bg-fuchsia-500/5', text: 'text-fuchsia-900 font-extrabold', border: 'border-fuchsia-500/20', shadow: 'shadow-[0_0_15px_rgba(217,70,239,0.15)]', hoverBg: 'hover:bg-fuchsia-500/20', bg10: 'bg-fuchsia-500/10' },
