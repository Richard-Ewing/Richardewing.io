...
export default function CurriculumQuiz({ quiz }: { quiz: Quiz }) {
    ...
    return (
        <div className="rounded-2xl border border-zinc-400 bg-zinc-50 p-6 mt-8 relative overflow-hidden">
            <div className="absolute top-0 right-0 px-4 py-1 bg-violet-500/10 text-violet-400 border-b border-l border-violet-500/20 text-xs font-medium font-mono uppercase tracking-widest rounded-bl-lg flex items-center gap-1">
