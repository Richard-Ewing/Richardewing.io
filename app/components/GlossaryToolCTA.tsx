        ...
        <div className="my-8 p-6 bg-gradient-to-r from-purple-500/5 to-cyan-500/5 border border-purple-500/20 rounded-2xl">
            <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                    <p className="text-xs font-bold text-zinc-900 font-bold font-mono uppercase tracking-wider mb-1">Free Tool</p>
                    ...
                    <Link
                        href={tool.url}
                        className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-purple-600 to-cyan-500 text-zinc-950 font-semibold text-sm font-semibold font-bold rounded-lg hover:opacity-90 transition-opacity"
                    >
                        Try {tool.name} Free →
                    </Link>
                </div>
