...
const CATEGORIES: TabCategory[] = [
    { id: 'foundations', label: '1. Fundamentals', description: 'Core Economic Principles (1-4)', color: 'from-cyan-500/20 to-blue-500/20 border-cyan-500/40 text-cyan-900 font-extrabold font-semibold shadow-[0_0_20px_rgba(34,211,238,0.15)] ring-1 ring-cyan-500/30' },
    ...
    { id: 'leadership', label: '5. Executive Leadership', description: 'Board-Level Communication (36-40)', color: 'from-orange-500/20 to-red-500/20 border-orange-500/40 text-orange-900 font-extrabold font-semibold shadow-[0_0_20px_rgba(249,115,22,0.15)] ring-1 ring-orange-500/30' },
    ...
    { id: 'playbooks', label: '7. Execution Guides', description: 'Tactical Open Blueprints (15-17)', color: 'from-emerald-500/20 to-teal-500/20 border-emerald-500/40 text-emerald-900 font-extrabold font-semibold shadow-[0_0_20px_rgba(16,185,129,0.15)] ring-1 ring-emerald-500/30' },
];
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    <div className="text-sm font-semibold font-bold whitespace-nowrap tracking-wide">{category.label}</div>
                                    <div className={`text-xs font-bold font-medium font-mono mt-1 uppercase tracking-widest ${isActive ? 'opacity-90' : 'opacity-50 text-zinc-950 group-hover/btn:text-zinc-950 font-bold'}`}>
