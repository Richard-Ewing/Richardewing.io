...
const COLLEGES: CategoryCard[] = [
    { 
        ...
        colorClasses: 'from-cyan-50 to-blue-50 border-cyan-300 text-cyan-900 font-extrabold group-hover:border-cyan-400 group-hover:shadow-md ring-cyan-300',
    ...
    { 
        ...
        colorClasses: 'from-violet-50 to-fuchsia-50 border-violet-300 text-violet-900 font-extrabold group-hover:border-violet-400 group-hover:shadow-md ring-violet-300',
    ...
    { 
        ...
        colorClasses: 'from-indigo-50 to-purple-50 border-indigo-300 text-indigo-900 font-extrabold group-hover:border-indigo-400 group-hover:shadow-md ring-indigo-300',
                        ...
                        <button
                            ...
                            className={`group relative flex flex-col items-start text-left p-6 w-full rounded-2xl border transition-all duration-500 ease-out overflow-hidden ${
                                isActive 
                                    ...
                                    : 'bg-white hover:bg-zinc-50 text-zinc-950 font-bold hover:text-zinc-950 border-zinc-400 hover:border-zinc-500'
                            }`}
                        >
                            <div className="absolute inset-0 bg-gradient-to-b from-white/[0.02] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                            
                            <div className={`relative flex items-center justify-between w-full transition-colors duration-300 ${isActive ? '' : 'text-zinc-900 group-hover:text-zinc-950'}`}>
                                {college.icon}
                                <span className={`text-xs font-bold font-medium font-mono tracking-widest px-2 py-1 rounded-md border ${isActive ? 'bg-white/60 border-zinc-400' : 'bg-transparent border-transparent text-zinc-950 font-bold'}`}>
                                    {college.stats}
                                </span>
                            </div>
                            ...
                            <div className="relative z-10 w-full mt-2">
                                ...
                                <p className={`text-xs font-bold leading-relaxed transition-opacity ${isActive ? 'opacity-90' : 'opacity-60 group-hover:opacity-80'}`}>
                                    {college.description}
                                </p>
                            </div>
                        </button>
