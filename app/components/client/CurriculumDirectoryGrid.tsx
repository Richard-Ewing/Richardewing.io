                        ...
                        <button
                            ...
                            className={`group relative flex flex-col items-start text-left p-6 w-full rounded-2xl border transition-all duration-500 ease-out overflow-hidden ${
                                isActive 
                                    ...
                                    : 'bg-white hover:bg-zinc-50 text-zinc-800 hover:text-zinc-950 border-zinc-400 hover:border-zinc-500'
                            }`}
                        >
                            ...
                            <div className={`relative flex items-center justify-between w-full transition-colors duration-300 ${isActive ? '' : 'text-zinc-900 group-hover:text-zinc-950'}`}>
                                {college.icon}
                                <span className={`text-xs font-medium font-mono tracking-widest px-2 py-1 rounded-md border ${isActive ? 'bg-white/60 border-zinc-400' : 'bg-transparent border-transparent text-zinc-800'}`}>
                                    {college.stats}
                                </span>
                            </div>
