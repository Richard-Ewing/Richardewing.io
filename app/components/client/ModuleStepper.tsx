        ...
        return (
            <div className="mb-12">
                <div className="flex items-center justify-between mb-4">
                    <span className="text-xs font-bold font-medium font-mono text-cyan-900 font-extrabold font-semibold uppercase tracking-widest flex items-center gap-2">
                        <BookOpen className="w-3 h-3" />
                        {currentStep === 0 ? 'Syllabus Introduction' : `Lesson ${currentStep} of ${totalSteps - 1}`}
                    </span>
                    <span className="text-xs font-bold font-medium font-mono text-zinc-950 font-bold uppercase tracking-widest bg-zinc-50 border border-zinc-400 px-2 py-1 rounded flex items-center gap-1">
