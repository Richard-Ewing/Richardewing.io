...
export default function CurriculumSalesPreview({ lessons = [] }: CurriculumSalesPreviewProps) {
    return (
        <div className="mt-16 relative overflow-hidden rounded-3xl border border-cyan-500/30 bg-zinc-950 shadow-[0_0_50px_rgba(6,182,212,0.1)]">
            {/* Background Glows */}
            ...
            {/* Header Content */}
            <div className="relative z-10 p-10 md:p-14 text-center border-b border-white/5 bg-black/40">
                ...
                <h2 className="text-3xl md:text-5xl font-grotesk font-bold text-white mb-6">
                    Unlock <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-500">Execution Fidelity</span>.
                </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto text-left mt-10">
                    <div className="bg-gradient-to-br from-white/5 to-transparent border border-white/10 rounded-2xl p-6 backdrop-blur-md relative overflow-hidden group hover:border-purple-500/50 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(168,85,247,0.15)]">
                        ...
                        <div className="relative z-10">
                            ...
                            <h4 className="text-white font-bold font-grotesk text-lg mb-2">Executive Dashboards</h4>
                            <p className="text-zinc-400 text-sm leading-relaxed">Generate deterministic, board-ready financial artifacts to justify CAPEX workflows immediately to your CFO.</p>
                        </div>
                    </div>
                    
                    <div className="bg-gradient-to-br from-white/5 to-transparent border border-white/10 rounded-2xl p-6 backdrop-blur-md relative overflow-hidden group hover:border-cyan-500/50 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(6,182,212,0.15)]">
                        ...
                        <div className="relative z-10">
                            ...
                            <h4 className="text-white font-bold font-grotesk text-lg mb-2">Defensible Economics</h4>
                            <p className="text-zinc-400 text-sm leading-relaxed">Replace heuristic guesswork with hard mathematical frameworks for build-vs-buy and SLA penalty negotiations.</p>
                        </div>
                    </div>
                    
                    <div className="bg-gradient-to-br from-white/5 to-transparent border border-white/10 rounded-2xl p-6 backdrop-blur-md relative overflow-hidden group hover:border-emerald-500/50 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(16,185,129,0.15)]">
                        ...
                        <div className="relative z-10">
                            ...
                            <h4 className="text-white font-bold font-grotesk text-lg mb-2">3-Step Playbooks</h4>
                            <p className="text-zinc-400 text-sm leading-relaxed">Actionable remediation templates attached to every module to neutralize friction and drive instant deployment velocity.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="relative bg-black overflow-hidden border-t border-white/5 pb-20 pt-10">
                ...
                <div className="max-w-6xl mx-auto px-6 relative z-10">
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-rose-500/10 border border-rose-500/20 text-rose-400 font-mono text-[10px] uppercase tracking-widest mb-6">
                            <span className="w-2 h-2 rounded-full bg-rose-500 animate-pulse" /> Highly Classified Assets
                        </div>
                        <h3 className="text-3xl font-bold font-grotesk text-white">Engineering Intelligence Awaiting Extraction</h3>
                    ...
                    <div className="relative w-full aspect-[21/9] flex items-center justify-center -mt-10 perspective-[1000px] select-none pointer-events-none">
                        ...
                        <div className="absolute inset-0 z-30 flex items-center justify-center backdrop-blur-[2px]">
                            <div className="bg-black/80 p-10 rounded-3xl border border-rose-500/30 shadow-[0_0_100px_rgba(0,0,0,0.8),inset_0_0_30px_rgba(244,63,94,0.1)] text-center max-w-md backdrop-blur-3xl transform scale-110 relative overflow-hidden">
                                ...
                                <div className="w-20 h-20 rounded-full bg-rose-500/10 border border-rose-500/30 flex items-center justify-center mx-auto mb-6 shadow-inner relative z-10">
                                    <Lock className="w-8 h-8 text-rose-500" />
                                </div>
                                <h4 className="text-2xl font-bold text-white mb-4 relative z-10 tracking-tight">Vault Terminal Locked</h4>
                                <p className="text-xs text-zinc-400 font-mono uppercase tracking-widest leading-relaxed relative z-10 bg-black/50 p-4 rounded-xl border border-white/5">
                        ...
                        <div className="absolute w-full h-full transform-style-3d opacity-20">
                            {/* Left Data Pane */}
                            <div className="absolute left-[5%] top-[15%] w-[35%] h-[60%] bg-zinc-900 border border-white/10 rounded-2xl p-6 transform -rotate-y-12 rotate-z-3 shadow-2xl overflow-hidden backdrop-blur-md">
                                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-cyan-500 to-transparent opacity-50" />
                                <div className="flex items-center justify-between mb-6">
                                    <div className="flex items-center gap-2">
                                        <Activity className="w-5 h-5 text-cyan-400" />
                                        <div className="text-xs font-mono uppercase text-cyan-400 font-bold">Telemetry Stream</div>
                                    </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="w-full flex gap-3 h-24 mt-2">
                                        <div className="flex-1 bg-white/5 rounded-lg border border-white/5 flex flex-col justify-end p-2 gap-1">
                                    ...
                                    <div className="w-full h-16 bg-white/5 rounded-xl border border-white/5 mt-4 flex items-center justify-between px-4">
                            ...
                            <div className="absolute right-[5%] top-[25%] w-[35%] h-[60%] bg-zinc-950 border border-purple-500/20 rounded-2xl p-6 transform rotate-y-12 -rotate-z-3 shadow-2xl overflow-hidden backdrop-blur-md">
                                ...
                                <div className="flex items-center gap-3 mb-6 border-b border-white/5 pb-4">
                                    ...
                                    <div className="text-xs font-mono uppercase text-zinc-400 tracking-widest">Inference Architecture</div>
                                </div>
                                <div className="font-mono text-[10px] text-purple-300/50 space-y-2">
                                    <div className="flex gap-4">
                                        <span className="text-zinc-600">01</span>
                                        <span className="text-emerald-400/50">import</span> <span>{'{ orchestrator }'}</span> <span className="text-emerald-400/50">from</span> <span className="text-amber-400/50">'@exogram/core'</span>;
                                    </div>
                                    <div className="flex gap-4">
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        <span className="text-purple-400/50">const</span> <span>router</span> = <span>new</span> <span className="text-cyan-400/50">AgentRouter</span>({`{`});
                                    </div>
                                    <div className="flex gap-4">
                                        <span className="text-zinc-600">04</span>
                                        <span className="ml-4 text-rose-400/50">strategy:</span> <span className="text-amber-400/50">'COST_EFFICIENT_SLM'</span>,
                                    </div>
                                    <div className="flex gap-4">
                                        <span className="text-zinc-600">05</span>
                                        <span className="ml-4 text-rose-400/50">fallback:</span> <span className="text-amber-400/50">'FRONTIER_MODEL'</span>
                                    </div>
                                    <div className="flex gap-4">
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        <span className="text-emerald-400/50">await</span> <span>router.guardrail</span>({`payload`});
                                    </div>
                                </div>
                            ...
                            <div className="absolute left-[30%] top-[5%] w-[40%] h-[20%] bg-zinc-900 border border-emerald-500/20 rounded-xl p-4 transform -translate-z-10 shadow-2xl flex items-center justify-between">
                                ...
                                <div className="w-16 h-6 rounded-full bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center">
                                    <div className="text-[8px] text-emerald-400 font-mono uppercase font-bold tracking-widest">+ 340%</div>
                                </div>
                            </div>
            ...
            <div className="relative p-10 bg-zinc-950">
                <div className="max-w-4xl mx-auto">
                    <h3 className="text-xl font-bold font-grotesk text-white mb-6 border-b border-white/10 pb-4 flex items-center gap-3">
                        <FileText className="w-5 h-5 text-cyan-400" /> Module Syllabus
                    </h3>
                ...
                <div className="absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-zinc-950 via-zinc-950/90 to-transparent pointer-events-none z-10" />
                ...
                <div className="absolute inset-x-0 bottom-12 flex items-center justify-center z-20 pointer-events-none">
                    <div className="bg-cyan-500/10 backdrop-blur-xl border border-cyan-500/20 rounded-full px-6 py-3 flex items-center gap-3 shadow-[0_0_30px_rgba(6,182,212,0.15)]">
                        ...
                        <span className="text-cyan-400 font-mono uppercase tracking-widest text-sm font-bold shadow-cyan-400 drop-shadow-md">Encrypted Vault Asset</span>
                    </div>
                </div>
            </div>
        </div>
