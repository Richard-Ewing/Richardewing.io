            ...
            <div className="bg-zinc-50 border-2 border-zinc-200 rounded-2xl p-6 sm:p-8 shadow-xl relative overflow-hidden">
                ...
                <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 divide-y md:divide-y-0 md:divide-x divide-zinc-200">
                    ...
                    <div className="space-y-5 md:pr-8">
                        ...
                        <form action={beehiivUrl} method="GET" target="_blank" className="flex flex-col sm:flex-row items-center gap-2 mt-4">
                            <input 
                                type="email" 
                                name="email" 
                                placeholder="name@company.com" 
                                required
                                className="w-full px-4 py-2.5 bg-white border border-zinc-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 font-medium text-sm text-zinc-900 placeholder:text-zinc-500"
                            />
                            <button 
                                type="submit"
                                className="w-full sm:w-auto px-5 py-2.5 rounded-lg bg-white border border-zinc-200 text-zinc-950 font-bold hover:bg-violet-600 hover:text-white hover:border-violet-600 transition-all text-sm whitespace-nowrap cursor-pointer shadow-sm"
                            >
                                Get PDF
                            </button>
                        </form>
                    ...
                    <div className="md:pl-8 pt-8 md:pt-0 flex flex-col justify-center space-y-4">
                        <div className="text-xs font-bold text-zinc-800 uppercase tracking-widest flex items-center gap-2 mb-1">
