...
export const CareerWinBenchmarkVisual = () => {
    ...
    return (
        <div className="my-12 bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 text-white shadow-2xl overflow-hidden relative">
            {/* Top Badge & Header */}
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-6 mb-6">
                <div>
                    <div className="flex items-center gap-2 text-xs font-mono font-bold text-coral-400 uppercase tracking-widest mb-1 text-orange-400">
                ...
                <div className="flex items-center gap-2 bg-slate-950 border border-slate-800 p-1.5 rounded-xl text-xs font-mono">
                    <button
                        ...
                        className={`px-3 py-1.5 rounded-lg font-bold transition-all ${
                            selectedTab === 'mirror' ? 'bg-orange-600 text-white shadow' : 'text-slate-400 hover:text-white'
                        }`}
                    >
                        LinkedIn Mirror
                    </button>
                    <button
                        ...
                        className={`px-3 py-1.5 rounded-lg font-bold transition-all ${
                            selectedTab === 'forge' ? 'bg-orange-600 text-white shadow' : 'text-slate-400 hover:text-white'
                        }`}
                    >
                        Evidence Forge
                    </button>
                    <button
                        ...
                        className={`px-3 py-1.5 rounded-lg font-bold transition-all ${
                            selectedTab === 'benchmark' ? 'bg-orange-600 text-white shadow' : 'text-slate-400 hover:text-white'
                        }`}
                    >
                        Comp Benchmarks
                    </button>
                ...
                <div className="space-y-4 animate-in fade-in duration-300">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs font-mono">
                        ...
                        <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 space-y-2">
                            ...
                            <div className="p-2 bg-red-950/40 border border-red-800/50 text-red-200 rounded flex justify-between">
                            ...
                            <div className="p-2 bg-emerald-950/40 border border-emerald-800/50 text-emerald-200 rounded flex justify-between">
                ...
                <div className="space-y-4 animate-in fade-in duration-300">
                    ...
                    <div className="bg-slate-950 p-5 rounded-2xl border border-slate-800 space-y-4 text-xs font-mono">
                        <div>
                            ...
                            <div className="p-3 bg-red-950/30 border border-red-900/50 text-slate-300 rounded-lg">
                                &ldquo;Led product strategy for enterprise SaaS platform and managed team.&rdquo;
                            </div>
                        </div>

                        <div className="flex justify-center">
                            <div className="w-8 h-8 rounded-full bg-orange-600/20 text-orange-400 flex items-center justify-center font-bold">
                                ↓
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="p-3 bg-emerald-950/40 border border-emerald-800/60 text-emerald-100 rounded-lg font-sans text-sm font-semibold">
                ...
                <div className="space-y-4 animate-in fade-in duration-300">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs font-mono">
                        <div className="bg-slate-950 p-4 rounded-xl border border-slate-800">
                            <span className="text-slate-400 block mb-1">Staff Engineer (L6)</span>
                            <span className="text-xl font-bold text-white">$340K - $420K</span>
                            <span className="text-[10px] text-emerald-400 block mt-1">+14% for AI Runtime Expertise</span>
                        </div>
                        <div className="bg-slate-950 p-4 rounded-xl border border-slate-800">
                            <span className="text-slate-400 block mb-1">VP Engineering (L8)</span>
                            <span className="text-xl font-bold text-white">$450K - $650K</span>
                            <span className="text-[10px] text-emerald-400 block mt-1">+0.5% - 1.5% Equity Target</span>
                        </div>
                        <div className="bg-slate-950 p-4 rounded-xl border border-slate-800">
                            <span className="text-slate-400 block mb-1">Fractional CPO</span>
                            <span className="text-xl font-bold text-white">$10K / mo</span>
                            <span className="text-[10px] text-orange-400 block mt-1">4 Engagements Max Cap</span>
                        </div>
                    </div>
                </div>
            )}
