...
const steps = [
    {
        ...
        icon: Search,
        title: "Diagnose",
        subtitle: "Measure your financial exposure",
        description: "Run the free 10-second AI & Engineering Budget Leak Benchmark to estimate your unmonitored overspend. Or book an executive rapid audit for a 30-minute scan of your cloud and AI invoices.",
    ...
    },
    {
        ...
        icon: FileBarChart,
        title: "Audit",
        subtitle: "Uncover hidden budget leaks",
        description: "An Engineering Financial Audit ($2,500 - $7,500) analyzes where your tech budget actually goes. You receive a clear executive report with dollar-denominated findings and immediate savings opportunities.",
        cta: { text: "Review audit packages", href: "/services" },
        color: "violet",
    },
    {
        number: "03",
        icon: Shield,
        title: "Govern",
        subtitle: "Install automated cost guardrails",
        description: "Implement automated spending limits, vendor access controls, and real-time usage rules. Move from unpredictable AI invoices to guaranteed, capped operating costs.",
        cta: { text: "Explore cost governance", href: "/framework" },
        color: "emerald",
    },
];
