            ...
            <div className="page-container">
                ...
                <div className="grid-3 max-w-5xl mx-auto">
                    ...
                    <Link href="/tools/pdi" className="card hover:border-purple-300 group block">
                        <div className="text-xs text-zinc-900 font-bold uppercase tracking-wide mb-2">01</div>
                    ...
                    <Link href="/tools/ev-se" className="card hover:border-purple-300 group block">
                        <div className="text-xs text-zinc-900 font-bold uppercase tracking-wide mb-2">02</div>
                    ...
                    <Link href="/tools/aueb" className="card hover:border-purple-300 group block">
                        <div className="text-xs text-zinc-900 font-bold uppercase tracking-wide mb-2">03</div>
                    ...
                    <Link href="/tools/aper" className="card hover:border-purple-300 group block">
                        <div className="text-xs text-zinc-900 font-bold uppercase tracking-wide mb-2">04</div>
                    ...
                    <Link href="/tools/audit-interview" className="card hover:border-purple-300 group block">
                        <div className="text-xs text-zinc-900 font-bold uppercase tracking-wide mb-2">05</div>
                    ...
                    <Link href="/tools" className="card border-dashed hover:border-zinc-500 group block">
                        <div className="text-xs text-zinc-900 font-bold uppercase tracking-wide mb-2">ALL TOOLS</div>
