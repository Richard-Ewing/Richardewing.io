        ...
        <section className="section-sm">
            <div className="page-container">
                ...
                <div className="grid-2 max-w-4xl mx-auto">
                    ...
                    {/* Finding 1 */}
                    <div className="card">
                        <div className="text-xs font-bold text-zinc-900 font-bold uppercase tracking-wide mb-2">Series C Platform</div>
                        ...
                        <p className="text-zinc-900 text-xs font-bold mt-4">73% of "new features" were debt payments</p>
                    </div>

                    {/* Finding 2 */}
                    <div className="card">
                        <div className="text-xs font-bold text-zinc-900 font-bold uppercase tracking-wide mb-2">B2B SaaS</div>
                        ...
                        <p className="text-zinc-900 text-xs font-bold mt-4">Output maintained, CFO now requires framework</p>
                    </div>
