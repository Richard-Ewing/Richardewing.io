        ...
        <section className="section-sm">
            <div className="page-container">
                ...
                <div className="grid-2 max-w-4xl mx-auto">
                    ...
                    {/* Finding 1 */}
                    <div className="card">
                        <div className="text-xs text-zinc-900 font-bold uppercase tracking-wide mb-2">Series C Platform</div>
                    ...
                    {/* Finding 2 */}
                    <div className="card">
                        <div className="text-xs text-zinc-900 font-bold uppercase tracking-wide mb-2">B2B SaaS</div>
