        ...
        <section className="section">
            <div className="page-container">
                ...
                <div className="grid-4 max-w-5xl mx-auto">
                    ...
                    <div className="card text-center flex flex-col justify-between h-full">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <Link href="/tools" className="block w-full text-center bg-zinc-50 border border-zinc-400 text-zinc-950 font-bold uppercase text-xs py-2 rounded hover:bg-zinc-100 transition-all">
                                All Tools
                            </Link>
                        </div>
                    </div>
                ...
                <div className="text-center mt-8">
                    <Link href="/advisory" className="text-zinc-800 hover:text-zinc-900 text-sm">
