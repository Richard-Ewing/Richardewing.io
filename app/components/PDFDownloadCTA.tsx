        ...
        <div className="mt-8 p-6 bg-gradient-to-r from-emerald-500/5 to-cyan-500/5 border border-emerald-500/20 rounded-2xl">
            <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-emerald-500/10 border border-emerald-500/20 rounded-xl flex items-center justify-center flex-shrink-0">
                    <FileDown className="w-6 h-6 text-emerald-900 font-extrabold font-semibold" />
                </div>
                <div className="flex-1">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                        ...
                        <Link
                            href="/benchmark"
                            className="inline-flex items-center gap-2 px-5 py-2.5 bg-white/5 border border-zinc-400 text-zinc-950 text-sm font-semibold font-bold rounded-lg hover:bg-white/10 transition-all"
                        >
