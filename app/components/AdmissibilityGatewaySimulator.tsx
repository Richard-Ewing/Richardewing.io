...
export const AdmissibilityGatewaySimulator = () => {
    ...
    return (
        <div className="my-12 bg-zinc-950 border border-purple-900/50 rounded-3xl p-6 sm:p-8 text-white shadow-2xl overflow-hidden relative">
            {/* Header */}
                ...
                <div className="flex items-center gap-2 bg-zinc-900 border border-zinc-800 p-1.5 rounded-xl text-xs font-mono">
                    <button
                        ...
                        className={`px-3 py-1.5 rounded-lg font-bold transition-all ${
                            scenario === 'token_blowout' ? 'bg-purple-600 text-white' : 'text-zinc-400 hover:text-white'
                        }`}
                    >
                        Token Blowout
                    </button>
                    <button
                        ...
                        className={`px-3 py-1.5 rounded-lg font-bold transition-all ${
                            scenario === 'unauthorized_exec' ? 'bg-purple-600 text-white' : 'text-zinc-400 hover:text-white'
                        }`}
                    >
                        Unauthorized Exec
                    </button>
                    <button
                        ...
                        className={`px-3 py-1.5 rounded-lg font-bold transition-all ${
                            scenario === 'valid_query' ? 'bg-purple-600 text-white' : 'text-zinc-400 hover:text-white'
                        }`}
                    >
                        Sanctioned Request
                    </button>
            ...
            {/* Terminal Screen */}
            <div className="bg-black/90 border border-zinc-800 rounded-2xl p-5 font-mono text-xs space-y-3 min-h-[220px] relative overflow-hidden">
                ...
                <div className="space-y-1.5">
                    <div className="text-zinc-400">
                        [<span className="text-purple-400">INBOUND PROMPT</span>] Payload received from agent-worker-89
                    </div>
                    ...
                    {simState === 'rejected' && (
                        <div className="p-3 bg-rose-950/50 border border-rose-800/80 rounded-xl space-y-1 text-rose-200 mt-3 animate-in fade-in">
                    ...
                    {simState === 'passed' && (
                        <div className="p-3 bg-emerald-950/50 border border-emerald-800/80 rounded-xl space-y-1 text-emerald-200 mt-3 animate-in fade-in">
