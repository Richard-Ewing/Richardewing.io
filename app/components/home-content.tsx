            ...
            <section className="flex-1 flex flex-col justify-center max-w-5xl mx-auto relative z-10 py-12 sm:py-20 px-4 sm:px-6">
                ...
                <div className="mb-10">
                    ...
                    <WordRotate
                        ...
                        className="text-xl sm:text-2xl font-grotesk font-extrabold force-gradient-text"
                        duration={3000}
                    />
                </div>
                ...
                <StatsBar
                    stats={[
                        { value: <><NumberTicker value={25} prefix="$" suffix="M" className="force-gradient-text font-bold" /></>, label: "ARR Scaled" },
                        { value: <><NumberTicker value={15} suffix="+" className="force-gradient-text font-bold" /></>, label: "Years Exp." },
                        { value: <><NumberTicker value={7} suffix="M+" className="force-gradient-text font-bold" /></>, label: "Users Impacted" },
                        { value: <span className="text-gold"><NumberTicker value={100} suffix="%" className="force-gradient-text font-bold" /></span>, label: "Independence" }
                    ]}
                    className="mb-8"
                />
