...
export function GovernanceStatus({ status, lastAssessmentDate }: GovernanceStatusProps) {
    const statusConfig = {
        Unknown: { icon: Shield, color: 'text-zinc-800', bg: 'bg-zinc-100', border: 'border-zinc-200', text: 'Baseline Required' },
    ...
    return (
        <div className={`p-5 rounded-xl border ${config.bg} ${config.border} flex items-center justify-between`}>
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h3 className="text-sm font-mono font-bold uppercase tracking-widest text-zinc-800 mb-1">Overall Governance Maturity</h3>
            ...
            {lastAssessmentDate && (
                <div className="text-right">
                    <div className="text-xs font-mono font-bold uppercase tracking-widest text-zinc-800 mb-1">Last Sync</div>
