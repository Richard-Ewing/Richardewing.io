...
export const metadata: Metadata = {
    title: 'AI Economics Doctrine & Principles',
    description: 'Strategic principles governing R&D capital allocation, technical debt liquidation, and AI gross margin defense.',
