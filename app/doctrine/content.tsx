                ...
                <div className="capsule-container p-6 sm:p-10 rounded-2xl sm:rounded-[2rem] mb-8">
                        ...
                        <a href="https://builtin.com/authors/richard-ewing" target="_blank" rel="noopener noreferrer" className="group">
                            <GlowCard className="p-5 h-full" glowColor="cobalt">
                                ...
                                <p className="text-xs text-zinc-600 leading-relaxed">
                                    Monthly columnist. Jan 2026 article featured in <span className="text-zinc-700">Editor's Newsletter</span>.
                                </p>
                            </GlowCard>
                        </a>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="p-5 border border-zinc-200 rounded-xl bg-cobalt/5 hover:border-cobalt/30 transition">
                            ...
                            <p className="text-xs text-zinc-700">7.7M user migration. Zero downtime.</p>
                        </div>
                        ...
                        <div className="p-5 border border-zinc-200 rounded-xl bg-emerald-500/5 hover:border-emerald-500/30 transition">
                            ...
                            <p className="text-xs text-zinc-700">Washington State. Gov. Jay Inslee.</p>
                        </div>
                    </div>
                </div>
            </ScrollReveal>
