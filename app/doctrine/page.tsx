        ...
        <main className="pt-20">
            <div className="page-container">
                    ...
                    <div className="max-w-4xl">
                        ...
                        <div className="grid-2">
                            ...
                            <div className="card">
                                ...
                                <p className="text-gray-500 text-sm">Monthly columnist. Jan 2026 article featured in Editor's Newsletter.</p>
                            </div>
                            ...
                            <div className="card">
                                ...
                                <p className="text-gray-500 text-sm">Feb 2026 article. Newsletter feature.</p>
                            </div>

                            <div className="card">
                                <div className="text-xs text-purple-400 uppercase tracking-wide mb-2">Expert Contributor</div>
                                <h3 className="font-semibold text-white mb-1">Foundry (CIO.com)</h3>
                                <p className="text-gray-500 text-sm">Monthly columnist for enterprise technology network.</p>
                            </div>
                            ...
                            <div className="card">
                                ...
                                <p className="text-gray-500 text-sm">4M+ monthly readers.</p>
                            </div>
                ...
                <section className="section-sm text-center">
                    <p className="text-gray-400 mb-6">Apply these principles to your organization.</p>
