...
const tracks = [
    ...
    },
    {
        ...
        courses: [
            ...
            { name: 'Product Economics Curriculum', url: '/curriculum/tracks', provider: 'Richard Ewing', description: '218 modules across 18 tracks covering engineering economics, AI operations, enterprise architecture, R&D capital management, leadership, M&A integration, and applied practice.', editorial: 'The comprehensive curriculum for understanding engineering as an economic activity. Start with Track 2 for AI economics.' },
            { name: 'AI Economics Deep Dive Guide', url: '/guides/ai-economics', provider: 'Richard Ewing', description: 'Complete guide to AI cost structures: inference, training, fine-tuning, and infrastructure economics.', editorial: 'My most comprehensive guide on AI economics. Covers everything from token pricing to GPU infrastructure costs.' },
                        ...
                        <section key={track.id} id={track.id}>
                            <div className="flex items-center gap-3 mb-8">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-zinc-800">{track.description}</p>
                                </div>
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center gap-2 mb-3">
                                                <span className="text-[10px] font-mono text-zinc-800 px-2 py-0.5 rounded-full border border-zinc-200 bg-zinc-50">{course.provider}</span>
                                            </div>
                ...
                <section id="reading" className="mt-20 max-w-5xl mx-auto">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-zinc-800">Books that shaped my thinking on AI economics and strategy.</p>
                        </div>
                    </div>
                ...
                <section id="tools" className="mt-20 max-w-5xl mx-auto">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-zinc-800">Open-source tools for managing AI costs, monitoring usage, and optimizing performance.</p>
                        </div>
                    </div>
                ...
                <section className="mt-12 max-w-3xl mx-auto">
                    <div className="card p-10 border-purple-500/20 bg-gradient-to-br from-purple-500/5 via-transparent to-cyan-500/5 text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <Link href="/tools/aueb" className="px-6 py-3 bg-white/5 border border-zinc-200 text-zinc-950 font-semibold rounded-lg hover:bg-white/10 transition-colors text-sm">
