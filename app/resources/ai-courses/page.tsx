...
const tracks = [
    ...
    },
    {
        ...
        courses: [
            ...
            { name: 'Product Economics Curriculum', url: '/curriculum/tracks', provider: 'Richard Ewing', description: '170 modules across 12 tracks covering engineering economics, AI operations, enterprise architecture, R&D capital management, and applied practice.', editorial: 'The comprehensive curriculum for understanding engineering as an economic activity. Start with Track 2 for AI economics.' },
