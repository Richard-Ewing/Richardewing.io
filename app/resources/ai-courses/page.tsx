...
const tracks = [
    ...
    },
    {
        ...
        courses: [
            ...
            { name: 'Product Economics Curriculum', url: '/curriculum/tracks', provider: 'Richard Ewing', description: '60 modules across 4 tracks covering engineering economics, AI costs, R&D capital management, and applied practice.', editorial: 'The comprehensive curriculum for understanding engineering as an economic activity. Start with Track 2 for AI economics.' },
