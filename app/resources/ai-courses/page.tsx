...
const tracks = [
    ...
    },
    {
        ...
        courses: [
            ...
            { name: 'Product Economics Curriculum', url: '/vault/curriculum/tracks', provider: 'Richard Ewing', description: '218 modules across 18 tracks covering engineering economics, AI operations, enterprise architecture, R&D capital management, leadership, M&A integration, and applied practice.', editorial: 'The comprehensive curriculum for understanding engineering as an economic activity. Start with Track 2 for AI economics.' },
