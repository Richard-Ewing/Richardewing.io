...
const MarginCalculator = () => {
    ...
    return (
        <section className="mb-12 py-8 px-6 bg-black/40 border border-white/5 rounded-3xl relative overflow-hidden backdrop-blur-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div>
                    ...
                    <input id="rev" type="number" value={rev} placeholder="100000" onChange={(e) => { setRev(e.target.value); calculate(); }}
                ...
                <div>
                    ...
                    <input id="cogs" type="number" value={cogs} placeholder="10000" onChange={(e) => { setCogs(e.target.value); calculate(); }}
                        className="w-full bg-black border border-white/20 rounded p-3 text-white font-mono focus:border-cyan-400 outline-none" />
                </div>
                <div>
                    <label htmlFor="ppl" className="block text-[10px] font-mono text-red-500 uppercase mb-2">Support & Maint. Salaries ($)</label>
                    <input id="ppl" type="number" value={ppl} placeholder="50000" onChange={(e) => { setPpl(e.target.value); calculate(); }}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-[100px_1fr] gap-8">
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-3">
                                <a href="/canonical/aper.html" className="px-4 py-2 bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 text-xs font-mono uppercase tracking-widest rounded hover:bg-cyan-500/20 transition">View PDF &rarr;</a>
                                <a href="/canonical/aper-diagnostic.html" className="px-4 py-2 bg-zinc-900/50 border border-white/10 text-zinc-400 text-xs font-mono uppercase tracking-widest rounded hover:text-white transition">Interactive Engine</a>
                            </div>
                        </div>
                    </div>
                </section>
