        ...
        <main className="pt-24 pb-24 px-6 min-h-screen">
            <div className="max-w-4xl mx-auto w-full relative z-10">
                ...
                <div className="mb-6 flex items-center gap-2 text-xs font-bold font-medium font-mono text-zinc-950 font-bold uppercase tracking-widest">
                    ...
                    <span>/</span>
                    <span className="text-zinc-950 font-bold">Signal</span>
                    <span>/</span>
                ...
                <ScrollReveal>
                    <div className="capsule-container rounded-2xl sm:rounded-[2rem] p-6 sm:p-10 lg:p-16 border border-zinc-400 bg-surface/50">
                        <span className="font-mono text-titanium text-xs font-bold uppercase tracking-[0.3em] mb-4 block">Compliance</span>
                        ...
                        <div className="space-y-8 max-w-4xl">
                            <section>
                                ...
                                <p className="text-zinc-900 leading-relaxed text-sm font-semibold sm:text-base mb-4">
                                ...
                                <p className="text-zinc-900 leading-relaxed text-sm font-semibold sm:text-base">
                            ...
                            <section>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4">
                                    <GlowCard className="p-4" glowColor="cyan">
                                        <div className="text-cyan-900 font-extrabold font-semibold text-lg mb-2">🔒</div>
                                        <div className="text-zinc-950 font-bold text-sm font-semibold mb-1">Secure Storage</div>
                                    ...
                                    <GlowCard className="p-4" glowColor="cobalt">
                                        ...
                                        <div className="text-zinc-950 font-bold text-sm font-semibold mb-1">No Tracking</div>
                                    ...
                                    <GlowCard className="p-4" glowColor="gold">
                                        ...
                                        <div className="text-zinc-950 font-bold text-sm font-semibold mb-1">Data Deletion</div>
                            ...
                            <section>
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                    <div className="p-3 border border-zinc-400 rounded-lg text-center hover:border-cyan-500/30 transition">
                                        ...
                                        <div className="text-zinc-950 font-bold text-xs font-bold font-medium">Team Efficiency Diagnostic</div>
                                    </div>
                                    <div className="p-3 border border-zinc-400 rounded-lg text-center hover:border-red-500/30 transition">
                                        ...
                                        <div className="text-zinc-950 font-bold text-xs font-bold font-medium">AI Unit Economics Benchmark</div>
                                    </div>
                                    <div className="p-3 border border-zinc-400 rounded-lg text-center hover:border-emerald-500/30 transition">
                                        ...
                                        <div className="text-zinc-950 font-bold text-xs font-bold font-medium">Product Debt Index</div>
                                    </div>
                                    <div className="p-3 border border-zinc-400 rounded-lg text-center hover:border-purple-500/30 transition">
                                        ...
                                        <div className="text-zinc-950 font-bold text-xs font-bold font-medium">Valuation Scenario Engine</div>
                                    </div>
                                    <div className="p-3 border border-zinc-400 rounded-lg text-center hover:border-cobalt/30 transition">
                                        ...
                                        <div className="text-zinc-950 font-bold text-xs font-bold font-medium">Quarterly Protocol</div>
                                    </div>
                                    <div className="p-3 border border-zinc-400 rounded-lg text-center hover:border-gold/30 transition">
                                        <div className="text-zinc-950 font-bold text-xs font-bold font-medium">Methodology & Brand</div>
                                    </div>
                                    <div className="p-3 border border-zinc-400 rounded-lg text-center hover:border-emerald-500/30 transition">
                                        <div className="text-zinc-950 font-bold text-sm">AUDIT™</div>
                                        <div className="text-zinc-950 font-bold text-xs font-bold font-medium">Audit Interview Protocol</div>
                                    </div>
                                </div>
                                <p className="text-zinc-950 text-xs font-bold mt-4">
                            ...
                            <section className="capsule-container p-6 rounded-xl">
                                ...
                                <a
                                    ...
                                    className="inline-flex items-center gap-2 text-cyan-900 font-extrabold font-semibold hover:text-zinc-900 transition font-mono text-sm"
                                >
                            ...
                            <div className="pt-8 border-t border-zinc-400 flex flex-col sm:flex-row justify-between items-center gap-4 text-zinc-950 text-xs font-bold sm:text-sm font-semibold font-mono">
