            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 py-24 sm:py-32">
                ...
                <div className="space-y-6 mb-16 animate-in fade-in slide-in-from-bottom-8 duration-1000">
                    ...
                    <div className="flex gap-4 items-center">
                        ...
                        <p className="text-sm font-mono text-zinc-500 border border-zinc-800 px-3 py-1 rounded-md">
                ...
                <div className="mt-24 pt-16 border-t border-zinc-800 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                        ...
                        <Link href="/tools" className="px-8 py-4 bg-transparent border border-zinc-600 text-zinc-300 font-bold uppercase tracking-widest text-sm rounded-lg hover:bg-zinc-900 transition-all">
