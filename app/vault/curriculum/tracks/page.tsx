...
const textMap: Record<string, string> = { cyan: 'text-cyan-800 font-semibold', violet: 'text-violet-400', emerald: 'text-emerald-800 font-semibold', amber: 'text-amber-400', orange: 'text-orange-800 font-semibold', pink: 'text-pink-400', red: 'text-red-800 font-semibold', sky: 'text-sky-400', indigo: 'text-indigo-800 font-semibold', rose: 'text-rose-400', teal: 'text-teal-400', lime: 'text-lime-400', fuchsia: 'text-zinc-950 font-semibolduchsia-400', blue: 'text-blue-800 font-semibold' };
