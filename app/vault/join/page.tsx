            ...
            <div className="w-full max-w-lg">
                ...
                <div className="card p-8 md:p-12 border-cyan-500/20 bg-gradient-to-br from-cyan-500/[0.05] to-transparent relative overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit} className="relative z-10">
                        <div className="mb-6">
                            <label htmlFor="inviteCode" className="block text-xs font-bold text-zinc-950 font-bold uppercase tracking-widest mb-2">
                                Team Invite Code
                            </label>
                            <input 
                                type="text" 
                        ...
                        {status === 'error' && (
                            <div className="mb-6 p-4 rounded-xl border border-red-500/30 bg-red-500/10 flex items-start gap-3">
                                <AlertCircle className="w-5 h-5 text-red-900 font-extrabold font-semibold shrink-0 mt-0.5" />
                                <div className="text-sm font-semibold text-zinc-900 font-medium">{errorMessage}</div>
                            </div>
                        )}

                        {status === 'success' ? (
                            <div className="w-full py-4 rounded-xl border border-green-500/50 bg-green-500/20 flex items-center justify-center gap-2 text-green-400 font-bold uppercase tracking-widest text-sm font-semibold shadow-[0_0_20px_rgba(34,197,94,0.2)]">
                            ...
                            <button 
                                ...
                                className={`w-full py-4 rounded-xl flex items-center justify-center gap-2 text-sm font-semibold font-bold uppercase tracking-widest transition-all ${
                        ...
                        <div className="mt-6 flex items-center justify-center gap-2 text-xs font-bold font-medium text-zinc-950 font-bold font-mono uppercase tracking-widest">
