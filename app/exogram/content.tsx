                            ...
                            <div className="relative bg-black rounded-xl p-8 border border-zinc-200">
                                <div className="flex justify-between items-start mb-8">
                                    <div>
                                        ...
                                        <p className="text-zinc-500 text-sm font-mono uppercase tracking-widest">Autonomous Research Agent</p>
                                    </div>
                                ...
                                <div className="bg-black border border-zinc-200 rounded-lg p-4 font-mono text-xs h-40 overflow-hidden relative">
                                    ...
                                    <div className="space-y-1 text-zinc-400 opacity-70">
                        ...
                        <div className="p-6 rounded-xl border border-zinc-200 bg-white/5">
                            ...
                            <div className="relative border-l border-zinc-200 ml-2 space-y-8">
                                ...
                                <div className="pl-6 relative">
                                    ...
                                    <div className="text-xs text-zinc-500 font-mono mb-1">2 days ago</div>
                                    <div className="text-white font-bold text-sm">Security Patch</div>
                                    <p className="text-xs text-zinc-500 mt-1">Routine dependency updates.</p>
                                </div>
                            </div>
                        </div>
                    </ScrollReveal>
