    ...
    return (
        <div className="max-w-6xl w-full relative z-10">
            ...
            <div className="mb-12">
                ...
                <h1 className="text-4xl sm:text-6xl font-grotesk font-bold text-white tracking-tight mb-4">
                ...
                <div className="lg:col-span-2 space-y-8">
                    <ScrollReveal>
                        <div className="relative group">
                            ...
                            <div className="relative bg-white rounded-xl p-8 border border-zinc-200">
                                <div className="flex justify-between items-start mb-8">
                                    <div>
                                        ...
                                        <p className="text-zinc-700 text-sm font-mono uppercase tracking-widest">Autonomous Research Agent</p>
                                    </div>
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
                                    <div className="p-4 bg-white/5 rounded-lg border border-zinc-200">
                                        <div className="text-xs text-zinc-700 font-mono uppercase mb-1">Context Window</div>
                                    ...
                                    <div className="p-4 bg-white/5 rounded-lg border border-zinc-200">
                                        <div className="text-xs text-zinc-700 font-mono uppercase mb-1">Memory Nodes</div>
                                    ...
                                    <div className="p-4 bg-white/5 rounded-lg border border-zinc-200">
                                        <div className="text-xs text-zinc-700 font-mono uppercase mb-1">Daily Inops</div>
                                    ...
                                    <div className="p-4 bg-white/5 rounded-lg border border-zinc-200">
                                        <div className="text-xs text-zinc-700 font-mono uppercase mb-1">Uptime</div>
                                        <div className="text-xl font-bold text-green-400 font-grotesk">99.9%</div>
                                    </div>
                                </div>

                                {/* Terminal Output / Log */}
                                <div className="bg-white border border-zinc-200 rounded-lg p-4 font-mono text-xs h-40 overflow-hidden relative">
                                    <div className="absolute top-2 right-2 flex gap-1">
                                        <div className="w-2 h-2 rounded-full bg-red-500/20"></div>
                                        <div className="w-2 h-2 rounded-full bg-yellow-500/20"></div>
                                        <div className="w-2 h-2 rounded-full bg-green-500/20"></div>
                                    </div>
                                    <div className="space-y-1 text-zinc-600 opacity-70">
                        ...
                        <div className="p-6 rounded-xl border border-zinc-200 bg-white/5">
                            ...
                            <div className="relative border-l border-zinc-200 ml-2 space-y-8">
                                <div className="pl-6 relative">
                                    ...
                                    <p className="text-xs text-zinc-700 mt-1">Improved context retrieval algorithms and semantic index.</p>
                                </div>
                                <div className="pl-6 relative">
                                    ...
                                    <p className="text-xs text-zinc-700 mt-1">Deployed High Contrast theme and new stats components.</p>
                                </div>
                                <div className="pl-6 relative">
                                    <div className="absolute -left-[5px] top-1 w-2.5 h-2.5 rounded-full bg-zinc-700 ring-4 ring-black" />
                                    <div className="text-xs text-zinc-700 font-mono mb-1">2 days ago</div>
                                    <div className="text-white font-bold text-sm">Security Patch</div>
                                    <p className="text-xs text-zinc-700 mt-1">Routine dependency updates.</p>
                                </div>
                            </div>
                        </div>
                    </ScrollReveal>
