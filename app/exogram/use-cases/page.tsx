...
export const metadata: Metadata = {
    title: 'Exogram Use Cases — AI Verification for Every Industry',
    description: 'How healthcare, fintech, legal, and enterprise AI teams use Exogram to verify AI outputs, prevent hallucinations, and ensure compliance.',
        ...
        <main className="pt-24 pb-20">
            <div className="page-container max-w-5xl mx-auto">
                ...
                <section className="text-center mb-16">
                    <p className="text-xs font-mono text-purple-400 uppercase tracking-widest mb-4">Industry Applications</p>
                ...
                <div className="space-y-8">
                    {useCases.map(uc => (
                        <section key={uc.title} className="rounded-2xl border border-white/10 bg-white/[0.03] p-8 hover:border-purple-500/20 transition-colors">
                            <div className="flex items-start gap-4 mb-6">
                                ...
                                <div>
                                    ...
                                    <h2 className="text-2xl font-grotesk font-bold text-white">{uc.title}</h2>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <p className="text-sm text-zinc-400 leading-relaxed">{uc.problem}</p>
                                </div>
                                <div>
                                    <h3 className="text-xs font-mono text-emerald-400 uppercase tracking-widest mb-3">Solution</h3>
                                    <p className="text-sm text-zinc-400 leading-relaxed">{uc.solution}</p>
                                </div>
                                <div>
                                    <h3 className="text-xs font-mono text-cyan-400 uppercase tracking-widest mb-3">Impact</h3>
                                    <p className="text-sm text-white font-semibold mb-3">{uc.impact}</p>
                                    <div className="flex flex-wrap gap-1.5">
                                        {uc.regulations.map(r => (
                                            <span key={r} className="text-[10px] font-mono text-zinc-500 px-2 py-0.5 rounded border border-white/5 bg-white/[0.02]">{r}</span>
                                        ))}
                                    </div>
                                </div>
                            </div>
                ...
                <section className="mt-16 text-center">
                    <div className="card p-10 border-purple-500/20 bg-purple-900/10">
                        <h2 className="text-2xl font-grotesk font-bold text-white mb-4">Your Industry Not Listed?</h2>
                        <p className="text-zinc-400 mb-6 max-w-lg mx-auto">Exogram&apos;s verification layers are industry-agnostic. If your AI system produces outputs that need to be trusted, Exogram can verify them.</p>
