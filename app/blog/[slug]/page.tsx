    ...
    return (
        <main className="pt-24 pb-20">
            <div className="page-container max-w-3xl mx-auto">
                <div className="flex items-center gap-2 text-xs text-zinc-900 font-bold mb-8">
                ...
                <header className="mb-12">
                    ...
                    <div className="flex items-center gap-4 text-xs text-zinc-900 font-bold">
                ...
                <div className="my-12 p-6 rounded-xl border border-cyan-500/20 bg-cyan-500/5 text-center">
                    ...
                    <p className="text-sm text-zinc-900 font-medium mb-4">Get the weekly engineering economics briefing — one email, every Monday.</p>
                    <a href="https://theproducteconomist.beehiiv.com/subscribe" target="_blank" rel="noopener noreferrer"
                        className="inline-block px-6 py-2.5 rounded-lg bg-gradient-to-r from-cyan-600 to-violet-600 text-zinc-950 font-semibold font-bold text-sm hover:opacity-90 transition-opacity">
                        Subscribe Free →
                    </a>
                </div>
                ...
                <div className="p-8 rounded-2xl border border-zinc-400 bg-white/[0.03]">
                    <div className="flex items-start gap-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-zinc-900 font-medium mb-3">The Product Economist — Quantifying engineering economics for technology leaders, PE firms, and boards.</p>
                            <div className="flex flex-wrap gap-3">
                                <Link href="/advisory" className="text-xs text-zinc-900 font-bold hover:underline">Book Advisory →</Link>
                                <Link href="/curriculum/tracks" className="text-xs text-zinc-900 font-bold hover:underline">Curriculum →</Link>
                                <Link href="/tools/pdi" className="text-xs text-zinc-900 font-bold hover:underline">Free Tools →</Link>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-12">
                    <Link href="/blog" className="text-sm text-zinc-900 font-medium hover:underline">← Back to Blog</Link>
                </div>
            </div>
        </main>
    );
