        ...
        <div className="min-h-screen flex items-center justify-center pt-20">
            <div className="max-w-md w-full mx-4 text-center">
                ...
                <Link 
                    ...
                    className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-white/5 border border-zinc-200 text-zinc-950 font-bold hover:bg-white/10 hover:border-violet-500/30 transition-all font-mono tracking-widest text-sm uppercase"
                >
