                    ...
                    <div className="capsule-container rounded-2xl sm:rounded-[2rem] p-6 sm:p-10 mb-8 border border-zinc-400">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                            <div className="space-y-6 md:col-span-2">
                                <div>
                                    <label className="text-xs font-mono text-indigo-800 font-semibold uppercase tracking-widest mb-3 flex items-center gap-2">
                     ...
                     <div className="flex flex-col sm:flex-row items-center justify-between bg-white/60 border border-indigo-500/20 rounded-2xl p-6 mb-8 backdrop-blur-md">
                        <div>
                            <div className="flex items-center gap-2 mb-2">
                                <span className="bg-indigo-500/20 text-indigo-800 font-semibold border border-indigo-500/50 px-2 py-0.5 rounded text-xs font-medium font-mono tracking-widest uppercase flex items-center gap-1"><Lock size={10} /> CONFIDENTIAL EXECUTIVE AUDIT</span>
                            </div>
                    ...
                    <div id="chunk-pdf-export-zone" className="space-y-6">
                                ...
                                <div className="min-h-[300px] relative z-10 w-full">
                                    {persona === 'CFO' && (
                                        <div className="flex flex-col md:flex-row gap-8 items-center">
                                            <div className="flex-1">
                                                <div className="text-xs font-mono text-zinc-800 uppercase tracking-widest mb-2">Hallucination Liability (CODN)</div>
                                                ...
                                                <div className="mt-6">
                                                     <span className={`px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest inline-flex items-center gap-2 ${results.efficiencyScore < 60 ? 'bg-red-50/30 text-rose-400 border border-red-900/50' : 'bg-indigo-900/30 text-indigo-800 font-semibold border border-indigo-900/50'}`}>
                                            ...
                                            <div className="flex-1 bg-white/50 p-6 rounded-2xl border border-zinc-400 space-y-4">
                                                ...
                                                <div className="flex justify-between items-center pb-2 border-b border-zinc-400">
                                                    ...
                                                    <span className="text-sm font-mono text-indigo-800 font-semibold">{results.chunks.length}</span>
                                                </div>
                                                <div className="flex justify-between items-center pb-2 border-b border-zinc-400">
                                    ...
                                    {persona === 'VP Eng' && (
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                                            <div>
                                                <div className="text-xs font-mono text-zinc-800 uppercase tracking-widest mb-2">Semantic Integrity Score</div>
                                                <div className={`text-6xl sm:text-7xl font-bold tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-r ${results.efficiencyScore < 50 ? 'from-rose-500 to-red-600' : 'from-indigo-400 to-cyan-400'}`}>
                                            ...
                                            <div className="bg-white/50 p-6 rounded-2xl border border-zinc-400 space-y-4 h-full flex flex-col justify-center">
                                                ...
                                                <div className="flex justify-between items-center pb-2">
                                                    ...
                                                    <span className="text-sm font-mono text-indigo-800 font-semibold">{rawText.length} Chars</span>
                                                </div>
                                                <div className="flex justify-between items-center pb-2">
                                                    <span className="text-sm text-zinc-900 font-medium">Overlap Redundancy</span>
                                                    <span className="text-sm font-mono text-cyan-800 font-semibold">{overlap} Chars</span>
                                                </div>
                                                <div className="flex justify-between items-center border-t border-zinc-400 pt-3">
                                                    ...
                                                    <span className={`text-sm font-mono font-bold ${results.brokenWords > 0 ? 'text-red-800 font-semibold' : 'text-emerald-800 font-semibold'}`}>-{results.brokenWords * 2}% Loss</span>
                                                </div>
                                            </div>
                                        </div>
                                    )}
                        ...
                        <ScrollReveal delay={150}>
                            <div className="mb-6 border-b border-zinc-400 pb-4">
                                <h3 className="text-xl font-bold text-zinc-950 mb-2 flex items-center gap-2">
                                    <Server size={18} className="text-indigo-800 font-semibold"/>
                                    ...
                                    <div key={chunk.id} className="relative group transition-all duration-300">
                                         ...
                                         <div className="bg-white border border-zinc-400 hover:border-zinc-500 rounded-xl p-6 pl-8 transition-colors">
                                              <div className="flex justify-between items-center mb-3">
                                                  <div className="text-xs font-mono uppercase tracking-widest text-indigo-800 font-semibold bg-indigo-500/10 px-2 py-0.5 rounded border border-indigo-500/20">
                                                      Vector Index [{index}]
                                                  </div>
                        ...
                        <ScrollReveal delay={200}>
                            <div className="bg-white border border-zinc-400 rounded-2xl p-6 mt-8 mb-8 shadow-2xl relative overflow-hidden">
                                <h3 className="text-xs font-mono text-cyan-800 font-semibold uppercase tracking-widest border-b border-zinc-400 pb-3 mb-6 flex justify-between">
                        ...
                        <ScrollReveal delay={220}>
                            <div className="mb-6 border-b border-zinc-400 pb-4 mt-8">
                                <h3 className="text-xl font-bold text-zinc-950 mb-2 flex items-center gap-2">
                                    <Server size={18} className="text-cyan-800 font-semibold"/>
                                ...
                                <div className="bg-white/5 border border-zinc-400 p-5 rounded-xl">
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-3">
                                            <div className="w-10 h-10 rounded-full bg-cyan-500/10 flex items-center justify-center border border-cyan-500/30 text-cyan-800 font-semibold font-bold shrink-0">API</div>
                                            <div>
                        ...
                        <ScrollReveal delay={250}>
                             <div className="mb-6 border-b border-zinc-400 pb-4 mt-8">
                                <h3 className="text-xl font-bold text-zinc-950 mb-2 flex items-center gap-2">
                                    <Database size={18} className="text-indigo-800 font-semibold"/>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                                <div className="bg-white/80 border border-zinc-400 p-6 rounded-xl relative overflow-hidden group hover:bg-zinc-100 transition-colors border-l-2 border-l-indigo-500">
                                     ...
                                     <div className="text-indigo-800 font-semibold font-mono text-xs mb-3 uppercase tracking-widest bg-indigo-500/10 w-8 h-8 rounded flex items-center justify-center border border-indigo-500/20">01</div>
                                ...
                                <div className="bg-white/80 border border-zinc-400 p-6 rounded-xl relative overflow-hidden group hover:bg-zinc-100 transition-colors border-l-2 border-l-cyan-500">
                                     ...
                                     <div className="text-cyan-800 font-semibold font-mono text-xs mb-3 uppercase tracking-widest bg-cyan-500/10 w-8 h-8 rounded flex items-center justify-center border border-cyan-500/20">02</div>
                        ...
                        <ScrollReveal delay={250}>
                            ...
                            <div className="flex justify-center flex-wrap gap-6 mt-8" data-html2canvas-ignore>
                                <button onClick={() => setResults(null)} className="text-zinc-950 font-mono tracking-widest text-xs hover:text-zinc-900 uppercase transition-colors">← Update Padding Parameters</button>
                            </div>
                        </ScrollReveal>
                    </div>
                </div>
