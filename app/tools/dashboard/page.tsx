    ...
    return (
        <div className="min-h-screen bg-[#050505] text-zinc-200">
            ...
            <main className="max-w-6xl mx-auto px-6 py-12 md:py-20">
                ...
                {/* TEMPORARY QA BANNER */}
                <div className="mb-12 bg-zinc-900 border border-emerald-500/30 rounded-2xl p-6 relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-64 h-64 bg-emerald-500/10 rounded-full blur-[80px]" />
                    <h2 className="text-xl font-bold text-white mb-2">QA Test Links (Temporary)</h2>
                    <p className="text-zinc-400 text-sm mb-6 max-w-2xl">To test the newly created enterprise direct Stripe links without having to trigger the paywall modal or complete a track locally, use these buttons:</p>
                    <div className="flex gap-4">
                        <a href="/api/buy/pe_intelligence_tier" className="px-6 py-3 rounded-lg bg-white text-black font-bold text-sm tracking-wide hover:bg-zinc-200 transition-colors shadow-lg">
                            Test $999 PE Intelligence Checkout
                        </a>
                        <a href="/api/buy/enterprise/enterprise_curriculum_license" className="px-6 py-3 rounded-lg bg-black text-white border border-white/20 font-bold text-sm tracking-wide hover:bg-white/10 transition-colors shadow-lg">
                            Test $1,500 Enterprise License Checkout
                        </a>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
                    <GlowCard className="p-8 bg-black/40 border border-white/10 rounded-3xl relative overflow-hidden group">
                        ...
                        <div className="text-sm font-mono text-zinc-500 uppercase tracking-widest mb-2">Identified Valuation Gap</div>
                    ...
                    <GlowCard className="p-8 bg-black/40 border border-white/10 rounded-3xl relative overflow-hidden group">
                        ...
                        <div className="text-sm font-mono text-zinc-500 uppercase tracking-widest mb-2">Eng Pipeline Confidence</div>
                        <div className="text-4xl font-bold font-grotesk text-white flex items-baseline gap-1">
