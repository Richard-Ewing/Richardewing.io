...
export const metadata: Metadata = {
    ...
    description: 'Calculate your Revenue Per Engineer and benchmark against Stripe ($3.2M), Figma ($2.8M), and Linear ($2.1M). Detect organizational bloat. Free diagnostic by Richard Ewing, Product Economist.',
    keywords: [
