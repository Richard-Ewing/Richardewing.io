      ...
      <div className="page-container">
        ...
        <section className="section-lg text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-zinc-950 mb-6">
            ...
            <span className="text-cyan-800 font-semibold">in 60 Seconds</span>
          </h1>
            ...
            <div className="space-y-16 max-w-5xl mx-auto">
              ...
              <div>
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h2 className="text-xl font-bold text-zinc-950 tracking-widest uppercase text-cyan-800 font-semibold">Financial Audits & Enterprise Valuation</h2>
                  <div className="h-px bg-white/10 flex-1"></div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Link href="/tools/pdi" className="group block">
                    <ShineBorder className="h-full bg-white border border-zinc-400 p-6 rounded-xl hover:bg-zinc-50 transition-colors" color={["#22d3ee", "#8b5cf6"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        <h3 className="text-lg font-bold text-zinc-950 mb-2 group-hover:text-cyan-800 font-semibold">Product Debt Index</h3>
                        ...
                        <span className="text-cyan-800 font-semibold text-xs font-bold uppercase tracking-wider">Run Diagnostic →</span>
                      </div>
                    </ShineBorder>
                  </Link>
                  ...
                  <Link href="/tools/ev-se" className="group block">
                    <ShineBorder className="h-full bg-white border border-zinc-400 p-6 rounded-xl hover:bg-zinc-50 transition-colors" color={["#22d3ee", "#8b5cf6"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        <h3 className="text-lg font-bold text-zinc-950 mb-2 group-hover:text-cyan-800 font-semibold">Valuation Scenario Engine</h3>
                  ...
                  <Link href="/tools/aueb" className="group block">
                    <ShineBorder className="h-full bg-white border border-zinc-400 p-6 rounded-xl hover:bg-zinc-50 transition-colors" color={["#22d3ee", "#8b5cf6"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        <h3 className="text-lg font-bold text-zinc-950 mb-2 group-hover:text-cyan-800 font-semibold">AI Unit Economics Benchmark</h3>
                  ...
                  <Link href="/tools/slm-vs-api" className="group block">
                    <ShineBorder className="h-full bg-white border border-zinc-400 p-6 rounded-xl hover:bg-zinc-50 transition-colors" color={["#22d3ee", "#8b5cf6"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        <h3 className="text-lg font-bold text-zinc-950 mb-2 group-hover:text-cyan-800 font-semibold">SLM vs API Arbitrage</h3>
              ...
              <div>
                <div className="flex items-center gap-4 mb-6">
                  <div className="h-px bg-white/10 flex-1"></div>
                  <h2 className="text-xl font-bold text-zinc-950 tracking-widest uppercase text-emerald-800 font-semibold">Agentic Defense & Security Ops</h2>
                  <div className="h-px bg-white/10 flex-1"></div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <a href="https://exogram.ai/proving-ground" target="_blank" rel="noopener noreferrer" className="group block">
                    <ShineBorder className="h-full bg-white border border-zinc-400 p-6 rounded-xl hover:bg-zinc-50 transition-colors" color={["#10b981", "#3b82f6"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        <h3 className="text-lg font-bold text-zinc-950 mb-2 group-hover:text-emerald-800 font-semibold">Deterministic Execution Sandbox</h3>
                        ...
                        <span className="text-emerald-800 font-semibold text-xs font-bold uppercase tracking-wider">Try Live Sandbox ↗</span>
                      </div>
                    </ShineBorder>
                  </a>
                  ...
                  <a href="https://exogram.ai/analyze" target="_blank" rel="noopener noreferrer" className="group block">
                    <ShineBorder className="h-full bg-white border border-zinc-400 p-6 rounded-xl hover:bg-zinc-50 transition-colors" color={["#10b981", "#3b82f6"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        <h3 className="text-lg font-bold text-zinc-950 mb-2 group-hover:text-emerald-800 font-semibold">Agentic Telemetry Analyzer</h3>
                        ...
                        <span className="text-emerald-800 font-semibold text-xs font-bold uppercase tracking-wider">Analyze Architecture ↗</span>
                      </div>
                    </ShineBorder>
                  </a>
                  ...
                  <Link href="/tools/shadow-ai" className="group block">
                    <ShineBorder className="h-full bg-white border border-zinc-400 p-6 rounded-xl hover:bg-zinc-50 transition-colors" color={["#10b981", "#3b82f6"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        <h3 className="text-lg font-bold text-zinc-950 mb-2 group-hover:text-emerald-800 font-semibold">Shadow AI Security Audit</h3>
                        ...
                        <span className="text-emerald-800 font-semibold text-xs font-bold uppercase tracking-wider">Run Diagnostic →</span>
                      </div>
                    </ShineBorder>
                  </Link>
                  ...
                  <Link href="/tools/prompt-injection-sandbox" className="group block">
                    <ShineBorder className="h-full bg-white border border-zinc-400 p-6 rounded-xl hover:bg-zinc-50 transition-colors" color={["#10b981", "#3b82f6"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        <h3 className="text-lg font-bold text-zinc-950 mb-2 group-hover:text-emerald-800 font-semibold">Prompt Injection Sandbox</h3>
                        ...
                        <span className="text-emerald-800 font-semibold text-xs font-bold uppercase tracking-wider">Run Red Team →</span>
                      </div>
                    </ShineBorder>
                  </Link>
                  ...
                  <Link href="/tools/rag-chunking-visualizer" className="group block md:col-span-2">
                    <ShineBorder className="h-full bg-white border border-zinc-400 p-6 rounded-xl hover:bg-zinc-50 transition-colors" color={["#10b981", "#3b82f6"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        <h3 className="text-lg font-bold text-zinc-950 mb-2 group-hover:text-emerald-800 font-semibold">RAG Chunking Visualizer</h3>
                        ...
                        <span className="text-emerald-800 font-semibold text-xs font-bold uppercase tracking-wider">Map Boundaries →</span>
                      </div>
                    </ShineBorder>
                  </Link>
                </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-zinc-950 mb-3">
                Level Up Your <span className="text-purple-800 font-semibold">AI Skills</span>
              </h2>
