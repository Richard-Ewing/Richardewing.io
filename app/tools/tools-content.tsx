      ...
      <div className="page-container">
            ...
            <div className="space-y-16 max-w-5xl mx-auto">
              ...
              <div>
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h2 className="text-xl font-bold text-white tracking-widest uppercase text-cyan-400">Financial Audits & Enterprise Valuation</h2>
                  <div className="h-px bg-white/10 flex-1"></div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Link href="/tools/pdi" className="group block">
                    <ShineBorder className="h-full bg-zinc-950 border border-white/5 p-6 rounded-xl hover:bg-zinc-900 transition-colors" color={["#22d3ee", "#8b5cf6"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        <h3 className="text-lg font-bold text-white mb-2 group-hover:text-cyan-400">Product Debt Index</h3>
                        <p className="text-gray-400 text-sm mb-4 flex-grow">Quantify hidden technical debt in dollar terms to measure the drag on corporate valuation.</p>
                  ...
                  <Link href="/tools/ev-se" className="group block">
                    <ShineBorder className="h-full bg-zinc-950 border border-white/5 p-6 rounded-xl hover:bg-zinc-900 transition-colors" color={["#22d3ee", "#8b5cf6"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        ...
                        <p className="text-gray-400 text-sm mb-4 flex-grow">Model exactly how delayed technical decisions compound and impact enterprise exit scenarios.</p>
                        <span className="text-cyan-400 text-xs font-bold uppercase tracking-wider">Run Diagnostic →</span>
                      </div>
                    </ShineBorder>
                  </Link>
                  ...
                  <Link href="/tools/aueb" className="group block">
                    <ShineBorder className="h-full bg-zinc-950 border border-white/5 p-6 rounded-xl hover:bg-zinc-900 transition-colors" color={["#22d3ee", "#8b5cf6"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        ...
                        <p className="text-gray-400 text-sm mb-4 flex-grow">Calculate your Generative AI gross margin collapse point before your user base hits it.</p>
                        <span className="text-cyan-400 text-xs font-bold uppercase tracking-wider">Run Diagnostic →</span>
                      </div>
                    </ShineBorder>
                  </Link>
                  ...
                  <Link href="/tools/slm-vs-api" className="group block">
                    <ShineBorder className="h-full bg-zinc-950 border border-white/5 p-6 rounded-xl hover:bg-zinc-900 transition-colors" color={["#22d3ee", "#8b5cf6"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        ...
                        <p className="text-gray-400 text-sm mb-4 flex-grow">Calculate the exact hardware breakeven point for repatriating cloud AI workloads to bare-metal servers.</p>
                        <span className="text-cyan-400 text-xs font-bold uppercase tracking-wider">Run Diagnostic →</span>
                      </div>
                    </ShineBorder>
                  </Link>
                  ...
                  <Link href="/tools/fte-displacement" className="group block">
                    <ShineBorder className="h-full bg-zinc-950 border border-white/5 p-6 rounded-xl hover:bg-zinc-900 transition-colors" color={["#a855f7", "#ec4899"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        <h3 className="text-lg font-bold text-white mb-2 group-hover:text-fuchsia-400">Agentic FTE Displacement Matrix</h3>
                        <p className="text-gray-400 text-sm mb-4 flex-grow">Calculate EBITDA expansion of replacing human Tier-1 support with autonomous LLM agents.</p>
                  ...
                  <Link href="/tools/cloud-repatriation" className="group block">
                    <ShineBorder className="h-full bg-zinc-950 border border-white/5 p-6 rounded-xl hover:bg-zinc-900 transition-colors" color={["#a855f7", "#ec4899"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        ...
                        <p className="text-gray-400 text-sm mb-4 flex-grow">Calculate the exact EBITDA recapture of moving off AWS to sovereign bare-metal architecture.</p>
                        <span className="text-fuchsia-400 text-xs font-bold uppercase tracking-wider">Run Diagnostic →</span>
                      </div>
                    </ShineBorder>
                  </Link>
                  ...
                  <Link href="/tools/agent-router" className="group block md:col-span-2">
                    <ShineBorder className="h-full bg-zinc-950 border border-white/5 p-6 rounded-xl hover:bg-zinc-900 transition-colors" color={["#a855f7", "#ec4899"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        ...
                        <p className="text-gray-400 text-sm mb-4 flex-grow">Calculate the compound token decay and GPU execution costs of multi-agent LLM reasoning workflows.</p>
              ...
              <div>
                <div className="flex items-center gap-4 mb-6">
                  <div className="h-px bg-white/10 flex-1"></div>
                  <h2 className="text-xl font-bold text-white tracking-widest uppercase text-emerald-400">Agentic Defense & Security Ops</h2>
                  <div className="h-px bg-white/10 flex-1"></div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <a href="https://exogram.ai/proving-ground" target="_blank" rel="noopener noreferrer" className="group block">
                    <ShineBorder className="h-full bg-zinc-950 border border-white/5 p-6 rounded-xl hover:bg-zinc-900 transition-colors" color={["#10b981", "#3b82f6"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        <h3 className="text-lg font-bold text-white mb-2 group-hover:text-emerald-400">Deterministic Execution Sandbox</h3>
                        <p className="text-gray-400 text-sm mb-4 flex-grow">Fire adversarial payloads at Exogram's 8-rule deterministic policy engine. Zero LLM.</p>
                  ...
                  <a href="https://exogram.ai/analyze" target="_blank" rel="noopener noreferrer" className="group block">
                    <ShineBorder className="h-full bg-zinc-950 border border-white/5 p-6 rounded-xl hover:bg-zinc-900 transition-colors" color={["#10b981", "#3b82f6"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        ...
                        <p className="text-gray-400 text-sm mb-4 flex-grow">Enforce a deterministic execution boundary for your autonomous AI agents.</p>
                  ...
                  <Link href="/tools/shadow-ai" className="group block">
                    <ShineBorder className="h-full bg-zinc-950 border border-white/5 p-6 rounded-xl hover:bg-zinc-900 transition-colors" color={["#10b981", "#3b82f6"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        ...
                        <p className="text-gray-400 text-sm mb-4 flex-grow">Calculate your enterprise blast radius for unauthorized shadow AI usage and IP Leakage.</p>
                  ...
                  <Link href="/tools/prompt-injection-sandbox" className="group block">
                    <ShineBorder className="h-full bg-zinc-950 border border-white/5 p-6 rounded-xl hover:bg-zinc-900 transition-colors" color={["#10b981", "#3b82f6"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        ...
                        <p className="text-gray-400 text-sm mb-4 flex-grow">Test your system prompts against modern jailbreaks, Base64 encodings, and roleplay bypasses.</p>
                  ...
                  <Link href="/tools/rag-chunking-visualizer" className="group block md:col-span-2">
                    <ShineBorder className="h-full bg-zinc-950 border border-white/5 p-6 rounded-xl hover:bg-zinc-900 transition-colors" color={["#10b981", "#3b82f6"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        ...
                        <p className="text-gray-400 text-sm mb-4 flex-grow">Visually optimize your Vector DB embeddings. See exactly where semantic context breaks across token limits.</p>
              ...
              <div>
                <div className="flex items-center gap-4 mb-6">
                  <div className="h-px bg-white/10 flex-1"></div>
                  <h2 className="text-xl font-bold text-white tracking-widest uppercase text-amber-500">Human Capital & Architecture</h2>
                  <div className="h-px bg-white/10 flex-1"></div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Link href="/tools/audit-interview" className="group block">
                    <ShineBorder className="h-full bg-zinc-950 border border-white/5 p-6 rounded-xl hover:bg-zinc-900 transition-colors" color={["#f59e0b", "#fbbf24"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        <h3 className="text-lg font-bold text-white mb-2 group-hover:text-amber-400">Audit Interview Protocol</h3>
                        <p className="text-gray-400 text-sm mb-4 flex-grow">The hiring methodology for the AI age. Reconfigure your funnel to test high-level architectural judgment, not raw syntax.</p>
                  ...
                  <Link href="/tools/career-pathing" className="group block">
                    <ShineBorder className="h-full bg-zinc-950 border border-white/5 p-6 rounded-xl hover:bg-zinc-900 transition-colors" color={["#f59e0b", "#fbbf24"]} classNameOverlay="opacity-0 group-hover:opacity-100">
                      <div className="flex flex-col h-full">
                        ...
                        <p className="text-gray-400 text-sm mb-4 flex-grow">A diagnostic engine mapping your specific career bottleneck directly to the required structural Curriculum Vault tracks.</p>
                        <span className="text-amber-400 text-xs font-bold uppercase tracking-wider">Run Diagnostic →</span>
                      </div>
                    </ShineBorder>
                  </Link>
        ...
        <section className="section-sm text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="https://exogram.ai" target="_blank" rel="noopener noreferrer" className="inline-block px-8 py-4 rounded-lg border border-white/20 text-white font-bold tracking-widest uppercase hover:bg-white/5 transition-colors">
