...
const faqs = [
    { q: 'What is EV/SE?', a: 'Enterprise Value per Software Engineer (EV/SE) measures how much enterprise value each software engineer creates or supports. It is calculated as Enterprise Value divided by total software engineering headcount. This metric is used by PE/VC firms, acquirers, and boards to assess engineering use and efficiency.', color: 'cyan' },
    { q: 'How is EV/SE used in M&A?', a: 'EV/SE is a key due diligence metric. A high EV/SE (e.g., above $5M/engineer) indicates the engineering team has high use  -  each engineer supports significant enterprise value. A low EV/SE may indicate overstaffing or that the technology is commoditized. Acquirers use EV/SE to benchmark targets against comparable transactions.', color: 'violet' },
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-xs font-bold font-medium font-mono text-zinc-950 font-bold uppercase tracking-widest">
                        ...
                        <Link href="/tools/ev-se" className="hover:text-cyan-900 font-extrabold font-semibold">EV/SE</Link><span>/</span>
