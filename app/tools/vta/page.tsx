...
export const metadata: Metadata = {
    title: 'Volatility Tax Auditor | Calculate Hidden AI Verification Cost...',
    description: 'Calculate your AI Volatility Tax - the hidden human-in-the-loop verification cost required when deploying generative AI features that suffer from response drift.',
    keywords: [
        'AI Volatility Tax',
