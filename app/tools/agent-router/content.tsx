                    ...
                    <div className="capsule-container rounded-2xl sm:rounded-[2rem] p-6 sm:p-10 mb-8 border border-zinc-200">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                            ...
                            <div className="p-6 bg-zinc-50 rounded-xl border border-zinc-200">
                                ...
                                <select title="Sequential Agent Hops" value={agentHops} onChange={e => setAgentHops(parseInt(e.target.value))} className="w-full bg-white/50 border border-zinc-200 rounded-xl p-4 text-zinc-950 font-mono focus:border-blue-500 transition-colors">
                            ...
                            <div className="p-6 bg-zinc-50 rounded-xl border border-zinc-200">
                                ...
                                <select title="Frontier Backbone Model" value={model} onChange={e => setModel(e.target.value)} className="w-full bg-white/50 border border-zinc-200 rounded-xl p-4 text-zinc-950 font-mono focus:border-blue-500 transition-colors">
                        ...
                        <ScrollReveal delay={120}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 text-sm">
                                <div className="bg-white/5 border border-zinc-200 p-5 rounded-xl">
                                    <h4 className="text-zinc-950 font-semibold mb-4 border-b border-zinc-200 pb-2">Compute Deprivation (Opportunity Cost)</h4>
                                    <div className="space-y-4">
                                        <div>
                                ...
                                <div className="bg-white/5 border border-zinc-200 p-5 rounded-xl">
                                    <h4 className="text-zinc-950 font-semibold mb-4 border-b border-zinc-200 pb-2">API Rate Limit Stacking</h4>
                                    <div className="space-y-4">
