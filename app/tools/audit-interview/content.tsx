            ...
            <ScrollReveal>
                <div className="capsule-container rounded-2xl sm:rounded-[2rem] p-6 sm:p-10 mb-8 overflow-hidden">
                    ...
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        <span className="font-mono text-xs font-bold text-zinc-900 font-bold uppercase tracking-widest">PROTOCOL V3 | SYSTEM OPERATIONAL</span>
                    </div>
                        ...
                        <GlowCard className="p-8 h-full flex flex-col justify-between group cursor-default" glowColor="cyan">
                            <div>
                                <div className="w-12 h-12 bg-emerald-500/10 rounded-xl flex items-center justify-center mb-6 border border-emerald-500/20 group-hover:scale-110 transition-transform duration-500">
                                    <Cpu className="text-emerald-900 font-extrabold font-semibold" size={24} />
                                </div>
                                <h3 className="text-2xl font-bold text-zinc-950 mb-2 group-hover:text-emerald-900 font-extrabold font-semibold transition-colors">Engineering</h3>
                                ...
                                <div className="flex flex-wrap gap-2 mb-8">
                                    {['AUDIT', 'SCALE', 'COST'].map(tag => (
                                        <span key={tag} className="px-2 py-1 bg-emerald-500/10 border border-emerald-500/20 rounded text-xs font-bold font-medium font-mono text-emerald-900 font-extrabold font-semibold">
                                            {tag}
                                        </span>
                                    ))}
                                </div>
                            ...
                            <ShineBorder borderColor="rgba(52, 211, 153, 0.6)" duration={3}>
                                <button
                                    ...
                                    disabled={loading}
                                    className="w-full py-4 bg-white text-black font-bold uppercase tracking-widest text-xs font-bold hover:bg-emerald-400 transition-all flex items-center justify-center gap-2 group-hover:shadow-[0_0_20px_rgba(52,211,153,0.3)] disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                        ...
                        <GlowCard className="p-8 h-full flex flex-col justify-between group cursor-default" glowColor="purple">
                            <div>
                                <div className="w-12 h-12 bg-indigo-500/10 rounded-xl flex items-center justify-center mb-6 border border-indigo-500/20 group-hover:scale-110 transition-transform duration-500">
                                    <Target className="text-indigo-900 font-extrabold font-semibold" size={24} />
                                </div>
                            ...
                            <ShineBorder borderColor="rgba(168, 85, 247, 0.6)" duration={3}>
                                <button
                                    ...
                                    disabled={loading}
                                    className="w-full py-4 bg-white text-black font-bold uppercase tracking-widest text-xs font-bold hover:bg-indigo-400 transition-all flex items-center justify-center gap-2 group-hover:shadow-[0_0_20px_rgba(168,85,247,0.3)] disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {loading ? 'INITIALIZING...' : (
                                        <>START PROTOCOL <ArrowRight size={14} /></>
                                    )}
                    ...
                    <div className="py-20 border-t border-zinc-400 relative">
                        <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 px-4 bg-white text-zinc-950 font-mono text-xs font-bold uppercase tracking-[0.2em]">System Doctrine</div>
                    ...
                    <div className="py-20 border-t border-zinc-400">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-zinc-950 font-mono text-xs font-bold uppercase tracking-widest">Every candidate runs the same simulation</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                ...
                                <div key={phase.id} className="p-6 bg-white border border-zinc-400 rounded-xl hover:border-zinc-500 transition-all hover:-translate-y-1 group">
                                    ...
                                    <div className="text-sm font-semibold font-bold text-zinc-950 uppercase tracking-wider mb-2">{phase.title}</div>
                                    <div className="text-sm font-semibold font-medium text-zinc-950 leading-relaxed">{phase.desc}</div>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="py-20 border-t border-zinc-400">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-zinc-950 font-mono text-xs font-bold uppercase tracking-widest">Enterprise-Grade Assessment Standard</p>
                        </div>

                        <div className="overflow-x-auto">
                            <table className="w-full text-left font-mono text-sm font-semibold border-collapse">
                                <thead>
                                    <tr className="border-b border-zinc-400 text-zinc-950 text-xs font-bold uppercase tracking-widest">
                                ...
                                <tbody className="divide-y divide-zinc-200">
                                    {[
                                        ...
                                        <tr key={i} className="hover:bg-white/5 transition-colors group">
                                            <td className="py-4 px-6 font-bold text-zinc-950 group-hover:text-emerald-900 font-extrabold font-semibold transition-colors">{row.l}</td>
                                            <td className="py-4 px-6 text-zinc-900">{row.d}</td>
                                            <td className="py-4 px-6 text-zinc-950 font-bold">{row.s}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
            ...
            {loading && (
                <div className="fixed inset-0 bg-white/80 backdrop-blur-sm z-[100] flex items-center justify-center">
                    <div className="flex flex-col items-center gap-4 animate-pulse">
                        ...
                        <div className="font-mono text-sm font-semibold uppercase tracking-widest text-emerald-500">Constructing Calibration Environment...</div>
                    </div>
                </div>
            )}
        </div>
