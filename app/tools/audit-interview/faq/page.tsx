        ...
        <main className="pt-20">
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="text-lg text-zinc-400 mb-12 max-w-2xl">Everything you need to know about AI-powered engineering assessment that tests judgment, not just syntax.</p>
                    ...
                    <div className="rounded-2xl border border-rose-500/30 bg-rose-500/5 p-8 mb-16">
                        ...
                        <p className="text-zinc-300 mb-6">Test your engineering judgment with our AI-powered assessment. Free to try.</p>
