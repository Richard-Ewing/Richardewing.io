...
export default function AdvisoryContent() {
    return (
        <div className="max-w-4xl w-full relative z-10">
            ...
            <ScrollReveal>
                <div className="capsule-container rounded-2xl sm:rounded-[2rem] p-6 sm:p-10 mb-8 overflow-hidden relative">
                    ...
                    <div className="relative">
                        ...
                        <p className="text-lg sm:text-xl text-zinc-900 max-w-2xl leading-relaxed mb-8">
                ...
                <div className="capsule-container rounded-2xl p-6 sm:p-8 mb-6 border-l-4 border-cyan-500">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
                        ...
                        <div className="flex gap-4">
                            <a href="https://theaieconomist.beehiiv.com/subscribe" target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-white text-black font-bold uppercase tracking-widest text-xs font-bold rounded hover:bg-cyan-400 transition-colors">
                                Subscribe Free
                            </a>
            ...
            <ScrollReveal delay={300} className="mt-16 border-t border-zinc-400 pt-16 mb-20">
                <div className="bg-gradient-to-br from-zinc-50 to-zinc-100 p-8 sm:p-12 rounded-2xl border border-zinc-400 relative overflow-hidden">
