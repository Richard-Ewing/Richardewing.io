        ...
        <main className="pt-20">
            <div className="page-container relative">
                ...
                <section className="section-lg text-center relative z-10">
                    <div className="text-xs font-mono text-purple-800 font-semibold uppercase tracking-widest mb-4 flex items-center justify-center gap-2">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
                        ...
                        <div className="card bg-zinc-100 border border-zinc-400 relative overflow-hidden group">
                            <div className="p-8">
                                ...
                                <a href="mailto:richard@richardewing.io?subject=Inquiry: Technical Due Diligence" className="flex items-center justify-center w-full py-4 text-xs font-bold font-mono tracking-widest rounded bg-cyan-500/10 text-cyan-800 font-semibold border border-cyan-500/20 hover:bg-cyan-500/20 transition-all uppercase">
                        ...
                        <ShineBorder className="card-featured relative p-0 overflow-hidden bg-white" color={["#10b981", "#34d399"]}>
                            ...
                            <div className="p-8 relative z-10 bg-gradient-to-b from-emerald-900/10 to-transparent">
                                <div className="absolute top-0 right-0 px-3 py-1 bg-emerald-500/20 text-emerald-800 font-semibold text-xs font-medium font-bold tracking-widest font-mono border-b border-l border-emerald-500/20 rounded-bl-lg">TOP TIER</div>
                        ...
                        <div className="card bg-zinc-100 border border-zinc-400 relative overflow-hidden group">
                            <div className="p-8">
                                <div className="text-xs font-mono text-purple-800 font-semibold uppercase tracking-widest mb-4">Tier 3: Enterprise Scale</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-white/50 border border-zinc-400 p-6 rounded-2xl hover:border-cyan-500/30 transition-all">
                            <div className="flex justify-between items-start mb-2">
                                ...
                                <span className="font-mono text-cyan-800 font-semibold">$2,500</span>
                            </div>
                            ...
                            <a href="/api/buy/insolvency_diagnostic" className="text-xs font-mono text-cyan-500 uppercase tracking-widest hover:text-cyan-800 font-semibold">Book Session →</a>
                        </div>
