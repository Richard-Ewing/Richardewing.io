        ...
        <main className="pt-20">
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="text-lg text-zinc-600 mb-12 max-w-2xl">Media and entertainment technology faces unique R&D economics: massive content delivery infrastructure, AI recommendation systems, complex rights management, and ad tech integration debt.</p>
                    ...
                    <div className="rounded-2xl border border-violet-500/30 bg-violet-500/5 p-8 text-center">
                        ...
                        <p className="text-zinc-700 mb-6">Quantify your streaming infrastructure debt, recommendation AI costs, and content delivery economics.</p>
