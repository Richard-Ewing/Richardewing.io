...
export const metadata: Metadata = {
    title: 'Product Economics for GovTech & Public Sector — Compliance, Legacy, AI | Richard Ewing',
    description: 'Product economics advisory for GovTech and public sector technology. Legacy system modernization, FedRAMP compliance costs, AI procurement governance, and citizen-facing system reliability.',
...
const challenges = [
    { icon: '🏛️', title: 'Legacy Mainframe Systems', description: 'Government systems built on COBOL and mainframes in the 1970s-90s carry the highest technical debt loads in existence. Modernization is multi-year and high-risk.' },
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
                        {challenges.map((c, i) => (
                            <div key={i} className="rounded-xl border border-white/10 p-6 hover:border-sky-500/30 transition-colors">
