...
const textMap: Record<string, string> = { emerald: 'text-emerald-800 font-semibold', amber: 'text-amber-400', cyan: 'text-cyan-800 font-semibold', rose: 'text-rose-400' };
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-xs font-medium font-mono text-zinc-800 uppercase tracking-widest">
                        <Link href="/industries" className="hover:text-cyan-800 font-semibold">Industries</Link><span>/</span><span className="text-emerald-800 font-semibold font-bold">AgriTech</span>
                    </div>
