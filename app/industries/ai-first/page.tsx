...
const challenges = [
    { icon: '📉', title: 'Margin Erosion', description: 'Every AI interaction costs money. Unlike traditional SaaS, AI-first products operate at 40-70% margins, compressing valuation multiples.' },
    { icon: '🔗', title: 'Model Dependency', description: 'Building on third-party models means your core capability is external. Price changes, deprecations, and regressions are commercial risks.' },
    ...
    { icon: '💰', title: 'Unsustainable Unit Economics', description: 'Most AI features are margin-negative when fully loaded. We model inference, retrieval, monitoring, and error handling to find profitability.' },
];
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-xs font-bold font-medium font-mono text-zinc-950 font-bold uppercase tracking-widest">
                        <Link href="/system" className="hover:text-cyan-900 font-extrabold font-semibold">Industries</Link><span>/</span><span className="text-orange-900 font-extrabold font-semibold font-bold">AI-First Companies</span>
                    </div>
