...
export const metadata: Metadata = {
    title: 'Product Economics for FinTech — R&D Audit & AI Governance | Richard Ewing',
    description: 'Product economics advisory for FinTech companies. Technical debt assessment for regulated financial services, AI governance for banking, and compliance cost optimization.',
...
const challenges = [
    ...
    { icon: '🤖', title: 'AI Governance Gap', description: 'AI in lending, fraud detection, and insurance creates regulatory liability. Models must be explainable, auditable, and bias-tested — or face enforcement action.' },
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
                        {challenges.map((c, i) => (
                            <div key={i} className="rounded-xl border border-white/10 p-6 hover:border-emerald-500/30 transition-colors">
