...
const textMap: Record<string, string> = { violet: 'text-violet-400', cyan: 'text-cyan-400', rose: 'text-rose-400', emerald: 'text-emerald-400' };
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-[10px] font-mono text-zinc-600 uppercase tracking-widest">
                        <Link href="/industries" className="hover:text-cyan-400">Industries</Link><span>/</span><span className="text-violet-400 font-bold">LegalTech</span>
                    </div>
                    ...
                    <p className="text-lg text-zinc-400 mb-12 max-w-2xl">Legal technology faces unique R&D economics: massive document processing costs, jurisdictional data maintenance, contract AI model drift, and highest-tier security requirements.</p>
                    ...
                    <div className="rounded-2xl border border-violet-500/30 bg-violet-500/5 p-8 text-center">
                        <h2 className="text-2xl font-grotesk font-bold text-white mb-4">LegalTech R&D Audit</h2>
                        <p className="text-zinc-300 mb-6">Quantify your document processing AI costs, compliance data debt, and security infrastructure burden.</p>
