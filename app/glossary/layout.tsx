...
export const metadata: Metadata = {
    title: 'AI Economics & Engineering Glossary',
    description: 'Definitive lexicon of AI economics, software capital, runtime governance, and technical insolvency terminology.',
    keywords: [
