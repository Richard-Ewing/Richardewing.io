...
export const aiMlTerms: GlossaryTerm[] = [
    ...
    },
    {
        ...
        whyItMatters: `Multimodal AI unlocks applications impossible with text-only models: document processing, visual inspection, video understanding, and rich content generation. But the cost premium for multimodal processing must be factored into unit economics.`,
        faqs: [
