...
While an engineer focuses on prompt orchestration and token window optimization, the AI Economist focuses on the *Return on Invested Capital (ROIC)* of those tokens. They are responsible for modeling [Synthetic COGS](/glossary/pillars/saas-metrics-due-diligence#synthetic-cogs), determining the Margin Collapse Threshold for high-frequency users, and ultimately preventing the engineering organization from building "Zombie AI" features that consume compute without driving provable business value.
    `,
    whyItMatters: `
