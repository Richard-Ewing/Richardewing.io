...
export const highVolumeTerms: GlossaryTerm[] = [
    ...
    },
    {
        ...
        whyItMatters: 'LLMs are the most major technology since the internet. But they introduce variable costs to software economics for the first time. Understanding LLM economics  -  cost per token, accuracy vs cost tradeoffs, and margin impact  -  is essential for any product leader building AI features.',
