...
export const sixteenthPassTerms: GlossaryTerm[] = [
    ...
    // More AI Terms (+5)
    {
        ...
        whyItMatters: 'Inference cost is the dominant variable in AI product economics. Every AI feature is an ongoing inference expense. Understanding inference economics prevents margin collapse.',
