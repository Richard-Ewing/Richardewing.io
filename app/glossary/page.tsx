...
export const metadata: Metadata = {
    title: 'Technology & AI Glossary — 300+ Definitions | Richard Ewing',
    description: 'The most comprehensive technology leadership glossary. 300+ definitions covering technical debt, AI economics, SaaS metrics, engineering management, product strategy, and more. By Richard Ewing, Product Economist.',
    keywords: [
    ...
    openGraph: {
        title: 'Technology & AI Glossary — 300+ Definitions | Richard Ewing',
        description: 'The most comprehensive technology leadership glossary. 300+ definitions on technical debt, AI economics, SaaS metrics, and engineering management.',
        url: 'https://www.richardewing.io/glossary',
        type: 'website',
    },
    twitter: {
        card: 'summary_large_image',
        title: 'Technology & AI Glossary — 300+ Definitions',
