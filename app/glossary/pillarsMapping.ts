...
export const KEEP_TERMS = [
    'admissibility-allowlist', 'agentic-drift-constant', 'agentic-kill-switch',
    'agentic-roi', 'ai-coding-tool-economics', 'ai-cogs',
    'ai-cost-attribution', 'ai-economist', 'ai-finops',
    'ai-hallucination', 'ai-hype-cycle-exhaustion', 'ai-liability-gradient',
    'ai-technical-debt', 'ai-unit-economics', 'ai-volatility-tax',
    'air-traffic-control-tax', 'aper-metric', 'audit-interview-protocol',
    'aueb-framework', 'autonomous-agent-readiness-index', 'calculating-roai',
    'career-levels', 'cleanup-time-metric', 'compound-ai-systems',
    'context-engineering', 'context-rot', 'coordination-tax',
    'cryptographic-audit-ledger', 'defensive-domain-architecture', 'deterministic-execution-control',
    'deterministic-governance', 'eaap-protocol', 'engineering-bottleneck-illusion',
    'engineering-levels', 'enterprise-governance-vacuum', 'eval-driven-development',
    'excess-capability', 'executable-specification', 'execution-harness-parity',
    'explainability-vs-recoverability', 'failure-cost-asymmetry', 'feature-bloat-calculus',
    'feature-level-finops', 'four-laws-probabilistic-software', 'four-pillars-of-agent-governance',
    'frontier-model-economics', 'frontier-model-economics-framework', 'hallucination-debt',
    'hardware-deflation-illusion', 'human-compiler-syndrome', 'ic-vs-management-track',
    'inference-dividend-cascade', 'inference-economics', 'innovation-tax',
    'interview-protocol', 'macro-coding', 'margin-engineering',
    'model-right-sizing', 'negative-carry-code-crisis', 'non-dilutive-infrastructure-use',
    'orchestration-debt', 'persistence-vs-authority', 'persistence-vs-authority-framework',
    'pr-review-gridlock', 'product-debt-index', 'product-economist',
    'prompt-injection', 'r-and-d-ponzi', 'review-debt',
    'semantic-caching', 'shadow-agents', 'shadow-ai',
    'shadow-delegation', 'shadow-mcp', 'silent-syntax-failure',
    'software-factory-overproduction', 'software-subscription-trap', 'spec-driven-agent-execution',
    'spec-driven-development', 'state-drift-in-persistent-agents', 'state-integrity-check',
    'supervisory-review-queue', 'supervisory-review-queue-framework', 'synthetic-cogs',
    'synthetic-model-collapse', 'systems-governor', 'technical-insolvency-date',
    'the-transaction-that-succeeds', 'the-transaction-that-succeeds-framework', 'tool-poisoning-attack',
    'unreliability-tax', 'variable-compute-cost', 'variable-cost-of-intelligence',
    'vendor-neutral-control-gateway', 'vibe-coding', 'zero-trust-type-gate',
    'zombie-code',
];
