                        ...
                        <GlowCard className="p-6" glowColor="cobalt">
                            ...
                            <ul className="space-y-4">
                                <li className="flex gap-3">
                                    <span className="text-cobalt text-lg">•</span>
                    ...
                    <div className="pt-8 border-t border-white/10">
                        <form name="book-waitlist" method="POST" className="max-w-md">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3">
                                ...
                                <button
                                    type="submit"
                                    className="bg-white text-black font-bold uppercase text-xs px-6 py-3 rounded-xl hover:bg-cobalt hover:text-white transition-all tracking-widest"
                                >
                                    Join Waitlist
                                </button>
                            </div>
