                ...
                <ScrollReveal>
                    <section className="mb-16 text-left">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mb-12">
                            <Link href="/services#gut_check" className="flex items-center justify-center px-8 py-4 rounded-xl text-sm uppercase tracking-widest font-bold transition-all bg-cyan-600 hover:bg-cyan-700 text-zinc-950 shadow-sm">
