...
export const metadata: Metadata = {
    title: 'Testimonials — What Clients Say About R&D Capital Audits | Richard Ewing',
    description: 'Client testimonials and social proof for R&D Capital Audits. See what CIOs, CTOs, PE partners, and board members say about product economics frameworks.',
            ...
            <div className="page-container">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-16">
                        {testimonials.map((t, i) => (
                            <div key={i} className="rounded-2xl border border-white/10 bg-white/[0.02] p-8 hover:border-amber-500/20 transition-colors">
                                ...
                                <blockquote className="text-zinc-300 text-sm leading-relaxed italic">&ldquo;{t.quote}&rdquo;</blockquote>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="rounded-2xl border border-amber-500/30 bg-amber-500/5 p-10 text-center">
                        ...
                        <p className="text-zinc-400 mb-8 max-w-xl mx-auto">See why PE firms, boards, and CTOs trust R&D Capital Audits for their most important technology investment decisions.</p>
