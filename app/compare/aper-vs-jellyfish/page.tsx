            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-xs font-bold font-medium font-mono text-zinc-950 font-bold uppercase tracking-widest">
                        <Link href="/compare" className="hover:text-cyan-900 font-extrabold font-semibold">Compare</Link><span>/</span><span className="text-emerald-900 font-extrabold font-semibold font-bold">APER vs Jellyfish</span>
                    </div>
                        ...
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="border-b border-zinc-400">
                                    ...
                                    <th className="text-left py-4 px-4 text-emerald-900 font-extrabold font-semibold font-mono uppercase tracking-widest text-xs">APER</th>
                                    <th className="text-left py-4 px-4 text-blue-900 font-extrabold font-semibold font-mono uppercase tracking-widest text-xs">Jellyfish</th>
                                </tr>
                            </thead>
                            <tbody>
                                {dimensions.map((d, i) => (
                                    <tr key={i} className="border-b border-zinc-400 hover:bg-zinc-50 transition-colors">
                                        ...
                                        <td className={`py-4 px-4 ${d.winner === 'aper' ? 'text-emerald-900 font-extrabold font-semibold' : 'text-zinc-900'}`}>{d.aper}</td>
                                        <td className={`py-4 px-4 ${d.winner === 'jellyfish' ? 'text-blue-900 font-extrabold font-semibold' : 'text-zinc-900'}`}>{d.jellyfish}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
