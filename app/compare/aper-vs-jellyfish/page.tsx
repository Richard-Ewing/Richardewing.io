...
export const metadata: Metadata = {
    title: 'APER vs Jellyfish — Engineering Metrics Comparison | Richard Ewing',
    description: 'Compare APER (Annual Productivity to Engineering Ratio) with Jellyfish for engineering metrics. See how revenue-per-engineer economics differs from engineering management platforms.',
