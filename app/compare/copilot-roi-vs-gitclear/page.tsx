...
export const metadata: Metadata = {
    ...
    description: 'Copilot ROI Forecaster vs GitClear comparison. Exogram measures the hidden EBITDA tax of AI-generated Vibe Coding Debt. GitClear measures code output volume.',
