            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    ...
                    <h1 className="text-4xl sm:text-5xl font-grotesk font-bold text-white mb-6">
                        {item.toolA} <span className="text-zinc-500 text-3xl mx-2">vs</span> <span className="text-rose-400">{item.toolB}</span>
                    </h1>
                    <p className="text-xl text-zinc-400 mb-12 border-l-2 border-cyan-500 pl-4 py-2">
                        {item.title}
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                        <div className="rounded-2xl border border-zinc-800 bg-white/[0.01] p-8">
                            ...
                            <p className="text-zinc-300 leading-relaxed">{item.theirFocus}</p>
                        </div>
                        <div className="rounded-2xl border border-cyan-500/30 bg-cyan-500/5 p-8 relative overflow-hidden">
                            ...
                            <p className="text-zinc-100 leading-relaxed font-medium">{item.ourAdvantage}</p>
                        </div>
                    </div>
                    ...
                    <div className="rounded-3xl border border-white/10 bg-black p-8 md:p-12 text-center relative overflow-hidden mt-20">
                        <div className="absolute inset-0 bg-gradient-to-b from-cyan-500/10 to-transparent opacity-50"></div>
                        <h3 className="text-2xl md:text-3xl font-grotesk font-bold text-white mb-4 relative z-10">
