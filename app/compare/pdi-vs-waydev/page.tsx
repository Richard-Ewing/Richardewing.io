...
export const metadata: Metadata = {
    title: 'PDI vs Waydev | Economic Intelligence Comparison',
    description: 'Waydev tracks developer metrics. PDI predicts technical insolvency. Compare engineering intelligence platforms for R&D capital decisions.',
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-xs font-bold font-medium font-mono text-zinc-950 font-bold uppercase tracking-widest">
                        <Link href="/compare" className="hover:text-cyan-900 font-extrabold font-semibold">Compare</Link><span>/</span><span className="text-cyan-900 font-extrabold font-semibold font-bold">PDI vs Waydev</span>
                    </div>
                        ...
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="border-b border-zinc-400">
                                    ...
                                    <th className="text-left py-4 px-4 text-cyan-900 font-extrabold font-semibold font-mono uppercase tracking-widest text-xs">PDI</th>
                                    <th className="text-left py-4 px-4 text-emerald-900 font-extrabold font-semibold font-mono uppercase tracking-widest text-xs">Waydev</th>
                                </tr>
                            </thead>
                            <tbody>
                                {dimensions.map((d, i) => (
                                    <tr key={i} className="border-b border-zinc-400 hover:bg-zinc-50 transition-colors">
                                        ...
                                        <td className={`py-4 px-4 ${d.winner === 'pdi' ? 'text-cyan-900 font-extrabold font-semibold' : 'text-zinc-900'}`}>{d.pdi}</td>
                                        <td className={`py-4 px-4 ${d.winner === 'waydev' ? 'text-emerald-900 font-extrabold font-semibold' : 'text-zinc-900'}`}>{d.waydev}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
