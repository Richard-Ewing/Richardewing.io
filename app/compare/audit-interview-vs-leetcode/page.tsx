...
export const metadata: Metadata = {
    title: 'Audit Interview vs LeetCode — Judgment vs Speed | Richard Ewing',
    description: 'Audit Interview Protocol vs LeetCode comparison. LeetCode tests code generation speed. The Audit Interview tests engineering judgment — the skill AI can\'t replace.',
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                        ...
                        <table className="w-full border-collapse">
                            <thead>
                                <tr className="border-b border-white/10">
                                    ...
                                    <th className="text-left py-4 px-4 text-xs font-mono text-zinc-400 uppercase tracking-widest">LeetCode</th>
                                </tr>
                            </thead>
                            <tbody>
                                {rows.map((row, i) => (
                                    <tr key={i} className="border-b border-white/5 hover:bg-white/[0.02]">
                                        ...
                                        <td className="py-4 px-4 text-sm text-zinc-400">{row.leet}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                    ...
                    <div className="text-center py-12 border-t border-white/10">
                        <p className="text-zinc-400 mb-4">Need help redesigning your hiring process?</p>
