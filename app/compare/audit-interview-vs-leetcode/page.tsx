            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-xs font-bold font-medium font-mono text-zinc-950 font-bold uppercase tracking-widest">
                        <Link href="/compare" className="hover:text-cyan-900 font-extrabold font-semibold">Compare</Link><span>/</span><span className="text-purple-900 font-extrabold font-semibold font-bold">Audit Interview vs LeetCode</span>
                    </div>
                        ...
                        <table className="w-full border-collapse">
                            <thead>
                                <tr className="border-b border-zinc-400">
                                    ...
                                    <th className="text-left py-4 px-4 text-xs font-bold font-mono text-purple-900 font-extrabold font-semibold uppercase tracking-widest">Audit Interview</th>
                                    <th className="text-left py-4 px-4 text-xs font-bold font-mono text-zinc-900 uppercase tracking-widest">LeetCode</th>
                                </tr>
                            </thead>
                            <tbody>
                                {rows.map((row, i) => (
                                    <tr key={i} className="border-b border-zinc-400 hover:bg-zinc-50">
                                        ...
                                        <td className="py-4 px-4 text-sm font-semibold text-zinc-900 font-medium">{row.audit}</td>
                                        <td className="py-4 px-4 text-sm font-semibold text-zinc-900 font-medium">{row.leet}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                    ...
                    <div className="rounded-2xl border border-purple-500/30 bg-purple-500/5 p-8 mb-16">
                        ...
                        <Link href="/tools/audit-interview" className="inline-block px-8 py-4 rounded-lg bg-gradient-to-r from-purple-500 to-pink-600 text-zinc-950 font-semibold font-bold hover:opacity-90 transition-opacity">
