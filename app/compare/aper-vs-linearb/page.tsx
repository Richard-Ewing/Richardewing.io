...
export const metadata: Metadata = {
    ...
    description: 'APER quantifies engineering economic yield. LinearB tracks PRs and cycle time. Which metric actually predicts R&D capital efficiency?',
            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex items-center gap-2 text-xs font-bold font-medium font-mono text-zinc-950 font-bold uppercase tracking-widest">
                        <Link href="/compare" className="hover:text-cyan-900 font-extrabold font-semibold">Compare</Link><span>/</span><span className="text-violet-400 font-bold">APER vs LinearB</span>
                    </div>
