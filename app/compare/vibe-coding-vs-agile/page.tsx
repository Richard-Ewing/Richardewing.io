...
export const metadata: Metadata = {
    title: 'Vibe Coding vs Agile — Debt Acceleration vs Planned Iteration',
    ...
    openGraph: { title: 'Vibe Coding vs Agile — Debt Acceleration vs Planned Iteration', description: 'Vibe Coding feels fast, but it generates hidden technical debt that breaks Agile sprint planning.', url: 'https://www.richardewing.io/compare/vibe-coding-vs-agile', type: 'article' },
};
