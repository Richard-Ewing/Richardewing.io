            ...
            <div className="page-container">
                <div className="max-w-4xl mx-auto">
                    ...
                    <h1 className="text-4xl sm:text-5xl font-grotesk font-bold text-white mb-6">
                        EV-SE <span className="text-zinc-700">vs</span>{' '}
                    ...
                    <div className="overflow-x-auto mb-16">
                        <table className="w-full border-collapse">
                            ...
                            <tbody>{rows.map((row, i) => (<tr key={i} className="border-b border-zinc-200 hover:bg-white/[0.02]"><td className="py-4 px-4 text-sm text-zinc-600 font-bold">{row.dimension}</td><td className="py-4 px-4 text-sm text-zinc-900">{row.evse}</td><td className="py-4 px-4 text-sm text-zinc-600">{row.jelly}</td></tr>))}</tbody>
                        </table>
                    </div>
