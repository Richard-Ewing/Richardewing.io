        ...
        ['16-5', 'Synergy Realization Tracking', 'The board approved the deal based on projected synergies. Now you have to deliver them — and prove it.',
            ...
            [
                l('Lesson 1: Cost Synergy Tracking', 'Cost synergies are concrete and measurable: eliminated duplicate systems, reduced headcount redundancy, consolidated vendor contracts. Track each synergy line item: projected savings, actual savings to date, and remaining runway. If projected savings were $5M over 3 years, show progress quarterly.', [
                    d('Line-Item Tracking', 'Every projected cost synergy gets its own tracking row with dates and amounts.', 'Example: "Consolidate 2 cloud platforms → save $200K/year → achieved month 8"'),
                ...
                l('Lesson 2: Revenue Synergy Measurement', 'Revenue synergies are promised but rarely achieved. Cross-sell to the acquired customer base, upsell with combined products, and enter new markets — these take longer than projected and are harder to attribute. Track: (1) Pipeline generated from cross-sell, (2) Closed revenue attributable to the acquisition, (3) New logos from the combined product.', [
                    ...
                    d('Attribution Discipline', 'Only count revenue as acquisition-related if it wouldn\'t have existed without the deal.', 'Loose attribution inflates synergy numbers and destroys credibility')
                ...
                l('Lesson 3: Quarterly Board Synergy Report', 'The board synergy report has 3 sections: (1) Score — overall synergy realization as a percentage of target (e.g., 72% of projected synergies achieved), (2) Detail — line-item tracking with green/yellow/red status, (3) Forecast — updated projection for remaining synergies with confidence levels.', [
                    d('Realization Score', 'Actual synergies achieved / Projected synergies at this stage.', 'Green: >85%. Yellow: 65-85%. Red: <65%'),
                    d('Traffic Light Detail', 'Each synergy line item: green (on track), yellow (at risk), red (not achievable).', 'Board members scan for red items — have mitigation plans ready'),
                    d('Revised Forecast', 'Updated 3-year synergy projection based on actual performance.', 'Adjust the forecast honestly. Unrealistic projections lose board trust.')
        ...
        ['16-9', 'Multi-Acquisition Portfolio Management', 'When you do it once, it\'s a project. When you do it repeatedly, it needs a playbook.',
            ...
            [
                l('Lesson 1: The Repeatable Integration Playbook', 'Companies that acquire frequently (2+ per year) need a standardized playbook: (1) Pre-close technical checklist, (2) Day 1-30 protection protocol, (3) Day 31-90 integration planning, (4) Day 91-180 execution, (5) Day 181-365 optimization. The playbook reduces integration time by 40% on the second acquisition and 60% by the fourth.', [
                    ...
                    d('Template Library', 'Standardized templates: DD report, integration plan, customer communication, synergy tracker.', 'Templates save 2-4 weeks of planning per acquisition'),
        ...
        ['16-10', 'Integration Post-Mortem & ROI Report', 'The honest assessment: did the acquisition create or destroy value?',
            ...
            [
                l('Lesson 1: The Honest Value Assessment', 'At the 18-month mark, calculate: Total acquisition cost (purchase price + integration costs + retention bonuses + opportunity cost) vs Total value created (revenue synergies + cost synergies + strategic value). Most acquirers never do this calculation because the answer is uncomfortable. But not knowing is worse.', [
                    ...
                    d('Total Value', 'Revenue synergies + cost synergies + strategic positioning + talent acquired.', 'Be honest about what actually materialized vs what was projected'),
                ...
                l('Lesson 2: Projection vs Actual Analysis', 'Compare the pre-acquisition deal model to actual results. For each projected synergy: projected amount, actual amount, variance, and root cause of the variance. This analysis is painful but essential for improving due diligence on future deals.', [
                    d('Revenue Synergy Accuracy', 'Projected cross-sell revenue vs actual. Most miss by 30-60%.', 'Revenue synergies are systematically over-estimated in deal models'),
                    d('Cost Synergy Accuracy', 'Projected cost savings vs actual. Usually achieve 70-90%.', 'Cost synergies are more reliable because they\'re within your control'),
