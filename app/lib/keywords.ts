...
export const SAAS_METRICS = [
    ...
    'SaaS valuation multiples 2026', 'software company valuation',
    'startup valuation', 'startup valuation calculator',
    'startup valuation methods', 'pre-money valuation', 'post-money valuation',
...
export const ENGINEERING_MANAGEMENT = [
    ...
    'DORA metrics', 'SPACE framework', 'DevEx', 'developer experience',
    ...
    'revenue per engineer', 'revenue per developer',
    ...
    'high-performing engineering teams', 'engineering excellence',
...
export const CONSULTING = [
    ...
    'AI implementation consulting', 'AI strategy consulting',
    'board-level technology advisory', 'board technology education',
...
export const DUE_DILIGENCE = [
    ...
    'code due diligence', 'software due diligence',
    'due diligence checklist', 'tech due diligence checklist',
    'due diligence for investors', 'due diligence for acquirers',
    'private equity due diligence', 'PE technology assessment',
    'venture capital due diligence', 'VC tech assessment',
    'M&A due diligence', 'acquisition due diligence',
    'pre-acquisition tech review', 'post-acquisition integration',
    'technology risk assessment', 'technology risk analysis',
    'software risk assessment', 'engineering risk evaluation',
    'hidden technology risks', 'technology red flags',
    'code quality assessment', 'architecture risk analysis',
    'scalability assessment', 'security assessment',
    'IP review', 'intellectual property assessment',
    'vendor technology assessment', 'supplier tech review',
    'investment technology screening', 'portfolio technology audit',
...
export const HIRING = [
    ...
    'technical recruiting', 'tech talent acquisition',
    ...
    'take-home assignment', 'pair programming interview',
    ...
    'problem-solving assessment', 'architecture skills test',
...
export const FINANCE_BUDGETS = [
    ...
    'engineering budget planning', 'technology spend',
    ...
    'contribution margin', 'marginal cost analysis',
...
export const TRENDING_FUTURE = [
    ...
    'AI transformation 2025', 'generative AI 2025',
    'technical debt 2025', 'developer productivity 2025',
    'SaaS growth 2025', 'AI adoption enterprise 2025',
    ...
    'AI cost trends 2026', 'engineering trends 2026',
    'product management trends 2026', 'startup trends 2026',
    'AI-native companies', 'AI-first development',
    'vibe coding', 'vibe coding risks', 'natural language programming',
    'AI software development', 'AI replaces developers',
    ...
    'future of product management', 'future of SaaS',
    'AGI timeline', 'artificial general intelligence',
    'AI singularity', 'post-AGI engineering',
    'autonomous software development', 'self-healing code',
    'AI-generated applications', 'zero-code development',
    'AI orchestration layer', 'AI operating system',
    ...
    'DevOps', 'DevSecOps', 'MLOps', 'LLMOps', 'AIOps',
...
export const BRANDED = [
    ...
    'AI economist', 'The AI Economist', 'AI economist framework',
    'AI economist', 'The AI Economist', 'AI economist framework', 'AI economics',
    'AI economist methodology', 'AI economist tools',
...
export const ARTICLE_DERIVED = [
    ...
    'AI product viability', 'AI AI economics', 'AI feature ROI',
