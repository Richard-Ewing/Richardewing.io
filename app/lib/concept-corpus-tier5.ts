...
export const TIER5_CONCEPTS: ConceptNode[] = [
  ...
  },
  {
    ...
    relatedConceptSlugs: [
      ...
      { slug: 'deterministic-governance', relationship: 'implements' },
      { slug: 'subprime-code-crisis', relationship: 'refines' }
    ],
    aeo: {
  ...
  },
  {
    ...
    evidenceLedger: [
      ...
      { id: 'ev-econ-7', title: 'Cursor vs Google Antigravity for Production AI Building', url: 'https://theaieconomist.beehiiv.com/p/cursor-vs-google-antigravity-for-production-ai-building-278a', publisher: 'Beehiiv', type: 'Industry Analysis', strength: 5, role: 'Extends', date: 'August 28, 2026' }
    ],
    relatedConceptSlugs: [
  ...
  },
  {
    ...
    personaRecommendations: [
      { role: 'Architect', takeaway: 'Build robust data capture pipelines that isolate verified human actions.', recommendedNextSlug: 'subprime-code-crisis' }
    ]
  }
];
