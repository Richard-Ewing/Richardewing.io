...
export function populateTracks1To4(modules: Record<string, CurriculumModule>) {
        ...
        ['3-19', 'Non-Dilutive Infrastructure Financing', 'Financing early AI and SaaS systems through hyperscaler startup credits and defensive domain architecture.', 
            ...
            [
                ...
                l('Lesson 3: Defensive Domain Architecture', 'As products gain initial market traction, defend brand identity early before domain squatters and competitors notice traffic growth.', [
                    ...
                    d('Directory Backlink Authority', 'Using AWS Startup Directory listings to secure enterprise-grade domain authority within weeks of launch.', 'Accelerates organic search engine indexing')
    ...
    const aiMods: [string, string, string, string[], ReturnType<typeof l>[]][] = [
        ...
        ['4-4', 'Rented Intelligence vs. Owned Capital', 'Decoupling enterprise context from hyperscaler model lock-in (Bedrock vs Vertex vs Self-Hosted).', 
            ['Treat raw model compute as utility overhead', 'Prevent the three phases of vendor capture', 'Deploy Vendor-Neutral Control Gateways', 'Preserve enterprise IP and commercial use'],
            [
