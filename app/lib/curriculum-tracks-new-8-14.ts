    ...
    const t11Mods: [string, string, string, string[], ReturnType<typeof l>[]][] = [
        ...
        ['11-2', 'API Provider Economics', 'The complete economic comparison of OpenAI, Anthropic, Google, and open-source alternatives.',
            ...
            [
                ...
                l('Lesson 2: Volume Discount Negotiation', 'At $50K+/month in API spend, providers will negotiate. Key use points: committed spend (guaranteeing $X/month for 12 months), multi-year contracts (lock in today\'s prices with annual volume growth), and multi-provider credible alternatives (showing Anthropic your OpenAI bill and vice versa).', [
                    ...
                    d('Competitive Use', 'Running a proof-of-concept on a competitor\'s API before negotiating.', 'Creates credible switching threat')
