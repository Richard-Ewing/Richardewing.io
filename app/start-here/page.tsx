...
export const metadata: Metadata = {
    ...
    description: 'New to product economics? Start here. Free diagnostic tools, 310+ glossary terms, learning tracks, and advisory services — a guided path from diagnosis to action.',
    keywords: [
    ...
    openGraph: {
        ...
        description: 'New here? Start with a free diagnostic, explore 310+ terms, and take the first step toward R&D capital efficiency.',
...
const steps = [
    ...
    },
    {
        ...
        description: 'Explore 310+ glossary terms, structured learning tracks for CTOs, PMs, and Investors, and published frameworks on technical debt, AI economics, and R&D capital allocation.',
        links: [
            { label: 'Glossary (310+ Terms)', href: '/glossary', primary: true },
                ...
                <div className="max-w-4xl w-full relative z-10 mx-auto">
                    ...
                    <div className="mb-16 border-b border-white/10 pb-12">
                        ...
                        <p className="text-lg text-zinc-400 leading-relaxed max-w-2xl">
                            Three steps from diagnosis to action. Free tools, 310+ definitions,
