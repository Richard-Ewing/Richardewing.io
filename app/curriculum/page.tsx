                ...
                <div className="max-w-6xl w-full relative z-10 mx-auto">
                    ...
                    <div className="mb-12 border-b border-white/10 pb-12">
                        ...
                        <div className="flex flex-wrap items-center gap-4 mt-8">
                            ...
                            >
                                Unlock All 170 Modules — $299/yr
                            </a>
                            <span className="text-zinc-600 text-sm">~$1.75/module · Cancel anytime</span>
                        </div>
                    </div>
                    ...
                    <div className="py-20 border-t border-white/10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                            ...
                            <div className="rounded-2xl border border-cyan-500/30 bg-cyan-500/5 p-6 flex flex-col">
                                ...
                                <div className="text-3xl font-bold text-white mb-1">$299<span className="text-lg text-zinc-500">/yr</span></div>
                                <div className="text-sm text-zinc-500 mb-1">All 170 modules · 12 tracks</div>
                                <div className="text-xs text-cyan-400 mb-6">~$1.75/module · Cancel anytime</div>
                                <ul className="space-y-2 mb-6 flex-1">
                                    <li className="flex items-start gap-2 text-sm text-zinc-400"><span className="text-cyan-400 mt-0.5">✓</span> All 170 modules, 12 tracks</li>
