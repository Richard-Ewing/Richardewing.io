    ...
    return (
        <main className="pt-20"><div className="page-container"><div className="max-w-4xl mx-auto">
            ...
            <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-8 text-center mb-12">
                <h2 className="text-lg font-grotesk font-bold text-white mb-2">🎓 Track 3 Capstone</h2>
                <p className="text-zinc-300 text-sm">This is the final module of Track 3. After completing all 6 modules, you can conduct end-to-end R&D Capital Audits and lead remediation programs.</p>
            </div>
