...
export default function BriefingsPage() {
    const briefs = [
        { number: '27', title: 'I Put AI Agents in Charge of My To-Do List (The Air Traffic Control Tax)', subtitle: 'Why delegating chores to AI creates an air traffic control supervisory review queue, silent syntax failures in code, and the 4 laws of agentic delegation.', href: 'https://builtin.com/articles/ai-agents-to-do-list', isNew: true, date: 'Sep 2026' },
        { number: '26', title: 'Claude Code vs. Gemini Spark: Persistence Is Not Authority', subtitle: 'Comparing terminal-supervised loops with unattended cloud persistence across workspace apps, state drift in recurring agents, and recoverability gaps.', href: 'https://builtin.com/articles/claude-code-vs-google-gemini-spark', isNew: true, date: 'Sep 2026' },
        { number: '25', title: 'Your AI Agent Made the Decision, but Your Company Owns the Risk', subtitle: 'Why the transaction that succeeds is your biggest risk, why monitoring is not authorization, and the 4 pillars of enterprise agent governance on CIO.com.', href: 'https://www.cio.com/article/4223955/your-ai-agent-may-have-made-the-decision-but-your-company-owns-the-risk.html', isNew: true, date: 'Sep 2026' },
        { number: '24', title: 'What Is a Frontier Model? The Moving Empirical Boundary', subtitle: 'Everyday vs. frontier AI, $78M to $191M training compute floors, open-weight vs. closed model trade-offs, and operational authority limits.', href: 'https://builtin.com/articles/frontier-model', isNew: true, date: 'Sep 2026' },
        { number: '23', title: 'The Software Factory Is Running 24/7 (And Nobody Wants the Output)', subtitle: 'Why autonomous code generation creates an overproduction crisis, how review debt chokes engineering, and the four personas navigating AI automation.', href: 'https://theaieconomist.beehiiv.com/p/the-software-factory-is-running-24-7-and-nobody-wants-the-output-c01a', isNew: false, date: 'Sep 2026' },
        { number: '22', title: 'The AI Hype Cycle Is Exhausting', subtitle: 'Escaping the software subscription trap, deploying the Interview Protocol, and capturing high-intent leads as AI answer engines replace the 10 blue links.', href: 'https://www.linkedin.com/pulse/ai-hype-cycle-exhausting-richard-ewing-3bdic/', isNew: true, date: 'Sep 2026' },
        { number: '21', title: 'The Bootstrapper\'s Cloud Credit Playbook', subtitle: 'How systematic execution across AWS Activate, Google for Startups, and Microsoft Founders Hub secures $100,000+ in non-dilutive infrastructure capital.', href: 'https://theaieconomist.beehiiv.com/p/the-bootstrapper-s-cloud-credit-playbook', isNew: true, date: 'Sep 2026' },
        { number: '20', title: 'The Engineering Bottleneck Illusion: What Copilot Adoption Taught Us', subtitle: 'Why typing code was never the primary constraint in software delivery and how AI code generation shifts bottlenecks downstream into review queues.', href: 'https://www.linkedin.com/pulse/engineering-bottleneck-illusion-what-copilot-adoption-richard-ewing-f5qhc/', isNew: true, date: 'Sep 2026' },
        { number: '19', title: 'Who’s Actually Responsible for Your AI Agents?', subtitle: 'Why autonomous agent deployment creates an enterprise governance vacuum and why you need a dedicated Systems Governor.', href: 'https://builtin.com/articles/who-governs-ai-agent', isNew: true, date: 'Sep 2026' },
        { number: '18', title: 'Bedrock, Vertex or Build It Yourself: AI Infrastructure', subtitle: 'Raw intelligence is rented utility overhead; corporate context is owned capital. How vendor-neutral gateways prevent lock-in.', href: 'https://www.cio.com/article/4215347/bedrock-vertex-or-build-it-yourself-the-ai-infrastructure-decision-most-cios-get-backwards.html', isNew: true, date: 'Aug 2026' },
