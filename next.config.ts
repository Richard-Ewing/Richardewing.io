...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/compare/mysql-vs-astro', destination: '/tools', permanent: true },
      // Tier C Spam Comparison Pages 301 Redirects to /tools
      { source: '/compare/chakra-ui-vs-terraform', destination: '/tools', permanent: true },
      { source: '/compare/trello-vs-stripe', destination: '/tools', permanent: true },
      { source: '/compare/bootstrap-vs-vue', destination: '/tools', permanent: true },
      { source: '/compare/mysql-vs-angular', destination: '/tools', permanent: true },
      { source: '/compare/datadog-vs-react', destination: '/tools', permanent: true },
      { source: '/compare/ansible-vs-circleci', destination: '/tools', permanent: true },
      { source: '/compare/grafana-vs-nuxt', destination: '/tools', permanent: true },
      { source: '/compare/docker-vs-astro', destination: '/tools', permanent: true },
      { source: '/compare/docker-vs-material-ui', destination: '/tools', permanent: true },
      { source: '/compare/bootstrap-vs-supabase', destination: '/tools', permanent: true },
      { source: '/compare/new-relic-vs-next-js', destination: '/tools', permanent: true },
      { source: '/compare/supabase-vs-angular', destination: '/tools', permanent: true },
      { source: '/compare/chakra-ui-vs-mysql', destination: '/tools', permanent: true },
      { source: '/compare/ansible-vs-next-js', destination: '/tools', permanent: true },
      { source: '/compare/new-relic-vs-angular', destination: '/tools', permanent: true },
      { source: '/compare/bootstrap-vs-jenkins', destination: '/tools', permanent: true },
      { source: '/compare/grafana-vs-remix', destination: '/tools', permanent: true },
      { source: '/compare/datadog-vs-gitlab-ci', destination: '/tools', permanent: true },
      { source: '/compare/ansible-vs-nuxt', destination: '/tools', permanent: true },
      { source: '/compare/supabase-vs-vue', destination: '/tools', permanent: true },
