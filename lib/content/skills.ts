...
{
  slug: "context-engineering-system",
  title: "Context Engineering Architecture System",
  category: "Cognitive Governance",
  failureSolved: "Context Rot & Semantic Contamination at Scale",
  description: "A complete system for structuring what AI models know when they answer. Deploys recursive context chunking, semantic caching layers, memory tiering, and deterministic data filtering to prevent context window pollution and ensure consistent agent reasoning.",
  difficulty: "Advanced",
  assetCount: 4,
  runtimeRelevance: "Critical",
  enterpriseRelevance: "Critical",
  exogramMapping: "Bounded Cognition Engine -> Context Architecture",
  price: 99,
  checkoutUrl: "https://buy.stripe.com/context-engineering",
  assetsList: ["Context chunking manifests", "Memory tier configuration", "Semantic cache integration guide", "RAG pipeline optimization templates"],
  version: "v1.0.0",
  searchKeywords: ["context engineering", "context engineering vs prompt engineering", "AI context window optimization", "LLM memory management", "RAG pipeline architecture"],
  whatBreaks: ["Context windows overflow with irrelevant data", "Agent reasoning degrades over long sessions", "Retrieval pipelines return noise instead of signal"],
  economicDamage: ["40% wasted tokens on irrelevant context", "3x inference costs from redundant retrievals"],
  whatSystemInstalls: ["Deterministic context filtering gates", "Semantic similarity thresholds", "Memory tier routing policies"],
  failureCascades: ["Context Rot", "Retry Inflation", "Hallucination Debt"],
  ctaText: "Deploy Context Engineering",
  runtimeLayer: "Skill Governance"
},
{
  slug: "spec-driven-development-system",
  ...
  runtimeRelevance: "High",
  enterpriseRelevance: "Critical",
  exogramMapping: "Admissibility Engine -> Specification Validation",
  price: 99,
  checkoutUrl: "https://buy.stripe.com/spec-driven-dev",
  assetsList: ["Specification schema templates", "Acceptance criteria generators", "AI agent constraint manifests", "Code review automation rules", "SDD workflow integration guide"],
  version: "v1.0.0",
  searchKeywords: ["spec driven development", "AI code specification", "vibe coding alternative", "structured AI coding", "AI agent code quality"],
...
{
  slug: "eval-driven-development-system",
  title: "Eval-Driven Development Pipeline",
  category: "Quality Governance",
  failureSolved: "Unreliability Tax & Hallucination Debt Accumulation",
  description: "An automated evaluation pipeline that continuously benchmarks AI system outputs against ground truth datasets, catching hallucinations, regressions, and confidence drift before they reach production. Transforms AI quality from subjective review to quantitative measurement.",
  difficulty: "Advanced",
  assetCount: 4,
  runtimeRelevance: "Critical",
  enterpriseRelevance: "Critical",
  exogramMapping: "Admissibility Engine -> Evaluation Benchmarks",
  price: 99,
  checkoutUrl: "https://buy.stripe.com/eval-driven-dev",
  assetsList: ["Evaluation benchmark suite", "Hallucination detection pipeline", "Regression monitoring dashboards", "Confidence scoring middleware"],
  version: "v1.0.0",
  searchKeywords: ["eval driven development", "AI evaluation pipeline", "LLM evaluation framework", "AI quality assurance", "hallucination detection"],
  whatBreaks: ["Hallucination rates climb silently across model versions", "No systematic quality measurement for AI outputs", "Manual testing cannot scale to probabilistic systems"],
  economicDamage: ["18% engineering ROI lost to unreliability tax", "Undetected regressions compound into customer-facing failures"],
  whatSystemInstalls: ["Automated evaluation benchmarks", "Continuous hallucination monitoring", "Confidence threshold enforcement"],
  failureCascades: ["Unreliability Tax", "Verification Collapse", "Synthetic Model Collapse"],
  ctaText: "Deploy Eval-Driven Development",
  runtimeLayer: "Skill Governance"
},
{
  slug: "margin-engineering-system",
  title: "AI Margin Engineering System",
  category: "Financial Governance",
  failureSolved: "AI Margin Collapse & Uncontrolled Inference Costs",
  description: "A comprehensive financial control system for AI-powered products that instruments feature-level P&L, enforces margin floors, and identifies the exact point where scaling AI features transitions from profitable to margin-destructive. Prevents AI Margin Collapse.",
  difficulty: "Advanced",
  assetCount: 5,
  runtimeRelevance: "High",
  enterpriseRelevance: "Mandatory",
  ...
  price: 99,
  checkoutUrl: "https://buy.stripe.com/margin-engineering",
  assetsList: ["Feature-level P&L templates", "Margin collapse calculator", "Inference cost attribution models", "Evergreen ratio dashboards", "Usage-based pricing migration guide"],
  version: "v1.0.0",
  searchKeywords: ["AI margin engineering", "AI feature economics", "LLM cost optimization", "AI SaaS margins", "inference cost management"],
  whatBreaks: ["Gross margins erode as AI features scale", "Most popular features are least profitable", "Growth accelerates losses instead of profits"],
  economicDamage: ["35% gross margin erosion from unmonitored AI features", "Negative unit economics on compute-intensive capabilities"],
  whatSystemInstalls: ["Feature-level cost attribution", "Automated margin floor enforcement", "AI Margin Collapse Point detection"],
  failureCascades: ["AI Margin Collapse", "Retry Inflation", "Negative Unit Economics"],
  ctaText: "Deploy Margin Engineering",
  runtimeLayer: "Environment Governance"
},
{
  slug: "ai-finops-instrumentation",
  title: "Feature-Level AI FinOps Instrumentation",
  category: "Financial Governance",
  failureSolved: "Invisible AI Infrastructure Costs & Token Burn",
  description: "Instruments real-time, feature-level cost allocation for AI inference, replacing opaque cloud bills with granular per-feature, per-user, per-session economic visibility. Maps every token burned to the product capability that consumed it.",
  difficulty: "Intermediate",
  assetCount: 4,
  runtimeRelevance: "High",
  enterpriseRelevance: "Mandatory",
  exogramMapping: "Economic Constraints -> Token Burn Attribution",
  price: 99,
  checkoutUrl: "https://buy.stripe.com/ai-finops",
  assetsList: ["Token burn analytics dashboards", "Cost allocation middleware", "Feature-level P&L reports", "Budget threshold alerting system"],
  version: "v1.0.0",
  searchKeywords: ["AI FinOps", "LLM cost allocation", "token cost tracking", "AI infrastructure costs", "inference cost attribution"],
  whatBreaks: ["Cloud bills grow 40% QoQ with no feature-level visibility", "Finance cannot attribute AI costs to specific capabilities", "Budget overruns discovered only at month-end reconciliation"],
  economicDamage: ["30% of token spend is unattributed waste", "No economic feedback loop between usage and cost"],
  whatSystemInstalls: ["Real-time token burn dashboards", "Feature-level cost attribution", "Automated budget threshold alerts"],
  failureCascades: ["AI Margin Collapse", "Retry Inflation", "Infrastructure Cost Spiral"],
  ctaText: "Deploy AI FinOps",
  runtimeLayer: "Environment Governance"
},
{
  slug: "ai-liability-assessment",
  title: "AI Liability Gradient Assessment",
  category: "Risk Governance",
  failureSolved: "Unquantified AI Deployment Liability & Regulatory Exposure",
  description: "A structured risk assessment framework that maps the escalating liability gradient from low-risk AI features (content suggestions) through high-risk autonomous actions (database writes, financial transactions) and helps organizations quantify their regulatory exposure under EU AI Act, state-level regulations, and industry-specific compliance requirements.",
  difficulty: "Advanced",
  assetCount: 4,
  runtimeRelevance: "High",
  enterpriseRelevance: "Mandatory",
  exogramMapping: "Identity Governance -> Liability Classification",
  price: 99,
  checkoutUrl: "https://buy.stripe.com/ai-liability",
  assetsList: ["Liability gradient classification matrix", "EU AI Act compliance checklist", "Agent permission tier mapping", "Risk quantification templates"],
  version: "v1.0.0",
  searchKeywords: ["AI liability", "AI compliance", "EU AI Act compliance", "AI risk assessment", "autonomous agent liability"],
  whatBreaks: ["AI agents take financially material actions without governance", "No liability classification for different AI capability tiers", "Regulatory exposure compounds across jurisdictions"],
  economicDamage: ["EU AI Act fines reach 7% of global turnover", "Uninsurable liability from ungoverned agent actions"],
  whatSystemInstalls: ["Liability tier classification", "Permission-scoped agent deployment", "Regulatory compliance mapping"],
  failureCascades: ["Shadow Agentic Execution", "MCP Tool Sprawl", "Regulatory Enforcement"],
  ctaText: "Deploy AI Liability Assessment",
  runtimeLayer: "Identity Governance"
}
];
